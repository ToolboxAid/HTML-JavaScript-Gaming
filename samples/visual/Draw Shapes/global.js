...
export const drawShapesUi = {
    ...
    attract: {
        title: 'Draw Shapes',
        prompt: 'Press Enter to view the shape gallery',
        subtitle: 'Explore basic canvas primitives and layered drawing order.',
        help: 'Use this sample to study shapes, outlines, grids, and transparency.',
        titleY: 148,
        promptY: 232,
        subtitleY: 286,
        helpY: 326
