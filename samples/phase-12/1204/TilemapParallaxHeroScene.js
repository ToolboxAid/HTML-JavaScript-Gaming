...
export default class TilemapParallaxHeroScene extends Scene {
  constructor() {
    super();
  ...
  render(renderer) {
    drawFrame(renderer, theme, [
      ...
      'Gameplay contract mirrors sample1203: jump, gravity, grounded, collision.',
      'Background layers use camera-relative parallax depth (far slower, near faster).',
      'No enemies, collectibles, or broader game systems.',
    ]);
    ...
    drawPanel(renderer, 620, 34, 300, 146, 'Parallax Hero', [
      `State: ${stateLabel}`,
