...
*/
import { Scene } from '../../../engine/scenes/index.js'; import { drawFrame, drawPanel } from '../../../engine/debug/index.js'; import { Theme, ThemeTokens } from '../../../engine/theme/index.js'; import { TileMapEditor } from '../../../engine/editor/index.js';
...
export default class TileMapEditorScene extends Scene {
  ...
  render(renderer) {
    drawFrame(renderer, theme, ['Engine Sample160', 'Tile editing stays data-driven and compatible with grid map content.', this.status]);
