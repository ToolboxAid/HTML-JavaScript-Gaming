...
World Vector Studio is a First-Class Tool V2 surface for terrain, tile/world geometry, layered scenes, level/environment layout, and parallax/background structures.
...
- The current implementation is the copied Tool Template V2 shell with World Vector Studio naming and documentation.
