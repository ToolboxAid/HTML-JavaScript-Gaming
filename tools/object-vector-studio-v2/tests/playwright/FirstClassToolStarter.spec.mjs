...
test.describe("Object Vector Studio", () => {
  ...
  test("launches with Palette Manager-style header shell", async ({ page }) => {
    ...
    await expect(page.locator("[data-tool-starter-header]")).toContainText("Object Vector Studio");
  ...
  test("Hide Header and Details toggles header state", async ({ page }) => {
    ...
    await expect(summary).toContainText(/Object Vector Studio|Show Header and Details/);
  });
