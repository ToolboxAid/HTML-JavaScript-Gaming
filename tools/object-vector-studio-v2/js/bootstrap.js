...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const app = new ToolStarterApp({
    ...
    elements: {
      ...
      previewCopyButton: requireElement("#objectVectorStudioV2PreviewCopyButton"),
      previewPasteButton: requireElement("#objectVectorStudioV2PreviewPasteButton"),
      previewRedoButton: requireElement("#objectVectorStudioV2PreviewRedoButton"),
      previewUndoButton: requireElement("#objectVectorStudioV2PreviewUndoButton"),
