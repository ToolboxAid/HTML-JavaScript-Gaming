...
High-level overview for '3D JSON Payload' under 'tools/3D JSON Payload/'.
...
## Entry Points
- Tool UI: 'tools/3D JSON Payload/index.html'
- How-to guide: 'tools/3D JSON Payload/how_to_use.html'
