export class ToolShellControl {
  constructor({ documentRef = document } = {}) {
    ...
    this.toolId = "audio-sfx-playground-v2";
    this.toolName = "Audio / SFX Playground V2";
    this.toolDescription = "First-Class Tools Surface V2";
    this.headerText = `${this.toolName} - ${this.toolDescription}`;
    this.introText = "Browser SFX preview, tuning, and toolState export.";
    this.suppressFullscreenSync = false;
  }

  mount() {
    this.document.body.classList.add("tools-platform-surface", "audio-sfx-local-shell");
  ...
  getSummaryElement() {
    return this.document.querySelector("[data-audio-sfx-summary]");
  }
