...
Copy `tools/_templates-v2/` to `tools/<tool-id>/`, then rename the class prefixes, visible title, and tool id references for the new First-Class Tool V2.
...
1. Copy `tools/_templates-v2/` to `tools/<tool-id>/`.
...
`npx playwright test --config tools/_templates-v2/playwright.config.mjs`
