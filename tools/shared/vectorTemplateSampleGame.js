...
import { normalizeString } from "../../src/shared/string/strings.js";
...
function remapPath(pathValue) {
  return normalizeString(pathValue).replace("tools/_templates-v2/vector-native-arcade/", "old_games/vector-arcade-sample/");
}
