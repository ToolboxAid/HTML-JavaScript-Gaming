...
function createRegistry() {
  ...
  const asteroidMediumVector = normalizeSvgToVectorAsset({
    ...
    path: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.asteroid.medium",
    paletteId: "palette.asteroids-hud",
    sourceTool: "svg-asset-studio",
  ...
  const asteroidSmallVector = normalizeSvgToVectorAsset({
    ...
    path: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.asteroid.small",
    paletteId: "palette.asteroids-hud",
    sourceTool: "svg-asset-studio",
  ...
  return {
    ...
    images: [
      ...
      },
      {
        ...
        path: "games/Asteroids/game.manifest.json#tools.asset-browser.assets.media.image.asteroids.bezel.path",
        sourceTool: "parallax-scene-studio"
      }
    ],
    parallaxSources: [
...
function createRuntimeAssetSources(registry) {
  return {
    ...
    "vector.asteroids.ship": {
      ...
      kind: "vector",
      file: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.ship",
      role: "ship"
    },
    "vector.asteroids.asteroid.large": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.asteroids.asteroid.large")),
      kind: "vector",
      file: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.asteroid.large",
      role: "asteroid-large"
    },
    "vector.asteroids.asteroid.medium": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.asteroids.asteroid.medium")),
      kind: "vector",
      file: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.asteroid.medium",
      role: "asteroid-medium"
    },
    "vector.asteroids.asteroid.small": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.asteroids.asteroid.small")),
      kind: "vector",
      file: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.asteroid.small",
      role: "asteroid-small"
    },
    "vector.asteroids.ui.title": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.asteroids.ui.title")),
      kind: "vector",
      file: "games/Asteroids/game.manifest.json#tools.svg-asset-studio.vectors.vector.asteroids.ui.title",
      role: "ui-title"
    },
