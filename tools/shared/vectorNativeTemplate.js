  ...
  return {
    ...
    palettes: [
      {
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/palettes/vector-native-primary.palette.json",
    ...
    vectors: [
      ...
      normalizeSvgToVectorAsset({
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-obstacle-large.vector.json",
        paletteId: "palette.vector-native.primary",
        sourceTool: "svg-asset-studio",
      ...
      normalizeSvgToVectorAsset({
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-obstacle-small.vector.json",
        paletteId: "palette.vector-native.primary",
        sourceTool: "svg-asset-studio",
      ...
      normalizeSvgToVectorAsset({
        ...
        name: "Template Title",
        path: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-title.vector.json",
        paletteId: "palette.vector-native.primary",
        sourceTool: "svg-asset-studio",
      ...
      normalizeSvgToVectorAsset({
        ...
        name: "Template HUD",
        path: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-hud.vector.json",
        paletteId: "palette.vector-native.primary",
        sourceTool: "svg-asset-studio",
    ...
    tilesets: [
      {
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/tilemaps/template-ui.tileset.json",
        paletteId: "palette.vector-native.primary",
        tileWidth: 8,
        tileHeight: 8,
    ...
    tilemaps: [
      {
        ...
        name: "Template Arena",
        path: "tools/templates-v2/vector-native-arcade/assets/data/tilemaps/template-arena.tilemap.json",
    ...
    images: [
      {
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/parallax/template-backdrop.svg",
    ...
    parallaxSources: [
      {
        ...
        path: "tools/templates-v2/vector-native-arcade/assets/data/parallax/template-backdrop.parallax.json",
...
function createRuntimeAssetSources(registry) {
  return {
    "palette.vector-native.primary": {
      kind: "palette",
      file: "tools/templates-v2/vector-native-arcade/assets/data/palettes/vector-native-primary.palette.json",
      colors: ["#05070DFF", "#E8F0FFFF", "#6FD3FFFF", "#FFB347FF"]
    },
    "vector.template.player": {
    ...
    "vector.template.obstacle.large": {
      ...
      kind: "vector",
      file: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-obstacle-large.vector.json",
      role: "obstacle-large"
    },
    "vector.template.obstacle.small": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.template.obstacle.small")),
      kind: "vector",
      file: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-obstacle-small.vector.json",
      role: "obstacle-small"
    },
    "vector.template.ui.title": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.template.ui.title")),
      kind: "vector",
      file: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-title.vector.json",
      role: "title"
    },
    "vector.template.ui.hud": {
      ...cloneJson(findRegistryEntry(registry?.vectors, "vector.template.ui.hud")),
      kind: "vector",
      file: "tools/templates-v2/vector-native-arcade/assets/data/vectors/template-hud.vector.json",
      role: "hud"
    },
    "tileset.template.ui": {
      kind: "tileset",
      file: "tools/templates-v2/vector-native-arcade/assets/data/tilemaps/template-ui.tileset.json",
      role: "ui-tileset"
    },
    "tilemap.template.arena": {
      kind: "tilemap",
      file: "tools/templates-v2/vector-native-arcade/assets/data/tilemaps/template-arena.tilemap.json",
      runtimeEntry: {
    ...
    "parallax.template.backdrop": {
      kind: "parallaxLayer",
      file: "tools/templates-v2/vector-native-arcade/assets/data/parallax/template-backdrop.parallax.json",
      role: "backdrop"
    }
  };
}
...
export function createVectorNativeTemplateDefinition() {
  ...
  return {
    templatePath: "tools/templates-v2/vector-native-arcade/",
    registry,
    ...
    configPath: "tools/templates-v2/vector-native-arcade/config/template.project.json",
    runtimeBootstrapPath: "tools/templates-v2/vector-native-arcade/runtime/bootstrap.runtime.json",
    docsPath: "tools/templates-v2/vector-native-arcade/docs/STARTER_GUIDE.md",
    rollbackNotesPath: "tools/templates-v2/vector-native-arcade/docs/ROLLBACK_NOTES.md"
  };
}
...
export async function buildVectorNativeTemplate(options = {}) {
  ...
  const ciValidationResult = await runCiValidationPipeline({
    branch: "tools/templates-v2/vector-native-arcade",
