...
export const TOOL_REGISTRY = Object.freeze([
  {
    ...
    shortLabel: "World",
    path: "old_world-vector-studio-v2",
    folderName: "old_world-vector-studio-v2",
    entryPoint: "old_world-vector-studio-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_world-vector-studio-v2/README.md"
      }
    ],
  ...
  },
  {
    ...
    shortLabel: "Object",
    path: "old_object-vector-studio-v2",
    folderName: "old_object-vector-studio-v2",
    entryPoint: "old_object-vector-studio-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_object-vector-studio-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Tile",
    path: "old_Tilemap Studio",
    folderName: "old_Tilemap Studio",
    entryPoint: "old_Tilemap Studio/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "How To Use",
        path: "old_Tilemap Studio/how_to_use.html"
      },
      {
  ...
  },
  {
    ...
    shortLabel: "Parallax",
    path: "old_Parallax Scene Studio",
    folderName: "old_Parallax Scene Studio",
    entryPoint: "old_Parallax Scene Studio/index.html",
    ...
    sampleEntryPoints: [
      {
        ...
        path: "old_Parallax Scene Studio/samples/sample-manifest.json"
      },
      {
        label: "Sample 1208 - Tool Formatted Tiles Parallax",
        path: "../samples/phase-12/1208/index.html"
  ...
  },
  {
    ...
    shortLabel: "Sprite",
    path: "old_Sprite Editor",
    folderName: "old_Sprite Editor",
    entryPoint: "old_Sprite Editor/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_Sprite Editor/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Assets",
    path: "old_asset-manager-v2",
    folderName: "old_asset-manager-v2",
    entryPoint: "old_asset-manager-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_asset-manager-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    path: "old_workspace-manager-v2",
    folderName: "old_workspace-manager-v2",
    entryPoint: "old_workspace-manager-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_workspace-manager-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Palette",
    path: "old_palette-manager-v2",
    folderName: "old_palette-manager-v2",
    entryPoint: "old_palette-manager-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_palette-manager-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Preview",
    path: "old_preview-generator-v2",
    folderName: "old_preview-generator-v2",
    entryPoint: "old_preview-generator-v2/index.html",
  ...
  },
  {
    ...
    shortLabel: "Speech",
    path: "old_text2speech-V2",
    folderName: "old_text2speech-V2",
    entryPoint: "old_text2speech-V2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_text2speech-V2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "SFX",
    path: "old_audio-sfx-playground-v2",
    folderName: "old_audio-sfx-playground-v2",
    entryPoint: "old_audio-sfx-playground-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_audio-sfx-playground-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "MIDI",
    path: "old_midi-studio-v2",
    folderName: "old_midi-studio-v2",
    entryPoint: "old_midi-studio-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_midi-studio-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    path: "old_collision-inspector-v2",
    folderName: "old_collision-inspector-v2",
    entryPoint: "old_collision-inspector-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_collision-inspector-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Storage",
    path: "old_storage-inspector-v2",
    folderName: "old_storage-inspector-v2",
    entryPoint: "old_storage-inspector-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_storage-inspector-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Input",
    path: "old_input-mapping-v2",
    folderName: "old_input-mapping-v2",
    entryPoint: "old_input-mapping-v2/index.html",
    ...
    sampleEntryPoints: [
      {
        label: "README",
        path: "old_input-mapping-v2/README.md"
      }
    ],
    visibleInToolsList: false
  },
  {
    ...
    shortLabel: "Inspect",
    path: "old_State Inspector",
    folderName: "old_State Inspector",
    entryPoint: "old_State Inspector/index.html",
  ...
  },
  {
    ...
    shortLabel: "Replay",
    path: "old_Replay Visualizer",
    folderName: "old_Replay Visualizer",
    entryPoint: "old_Replay Visualizer/index.html",
  ...
  },
  {
    ...
    shortLabel: "Perf",
    path: "old_Performance Profiler",
    folderName: "old_Performance Profiler",
    entryPoint: "old_Performance Profiler/index.html",
  ...
  },
  {
    ...
    shortLabel: "Physics",
    path: "old_Physics Sandbox",
    folderName: "old_Physics Sandbox",
    entryPoint: "old_Physics Sandbox/index.html",
  ...
  },
  {
    ...
    shortLabel: "Pipeline",
    path: "old_Asset Pipeline",
    folderName: "old_Asset Pipeline",
    entryPoint: "old_Asset Pipeline/index.html",
  ...
  },
  {
    ...
    shortLabel: "3D JSON",
    path: "old_3D JSON Payload",
    folderName: "old_3D JSON Payload",
    entryPoint: "old_3D JSON Payload/index.html",
  ...
  },
  {
    ...
    shortLabel: "3D View",
    path: "old_3D Asset Viewer",
    folderName: "old_3D Asset Viewer",
    entryPoint: "old_3D Asset Viewer/index.html",
  ...
  },
  {
    ...
    shortLabel: "3D Cam",
    path: "old_3D Camera Path Editor",
    folderName: "old_3D Camera Path Editor",
    entryPoint: "old_3D Camera Path Editor/index.html",
