...
export const TOOL_REGISTRY = Object.freeze([
  ...
  },
  {
    id: "3d-map-editor",
    name: "3D Map Editor",
    displayName: "3D Map Editor",
    shortLabel: "3D Map",
    path: "3D Map Editor",
    folderName: "3D Map Editor",
    entryPoint: "3D Map Editor/index.html",
    description: "Baseline 3D map document editor for point and segment layout with normalized JSON output.",
    showcaseTag: "3D",
