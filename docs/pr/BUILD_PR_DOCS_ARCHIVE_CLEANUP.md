...
2. Move the exact files in `docs/dev/reports/docs_archive_pr_move_manifest.txt` from `docs/pr/` to `docs/archive/pr/legacy-pr-history/`.
3. Leave the exact files in `docs/dev/reports/docs_archive_pr_keep_manifest.txt` in place.
