...
Create `docs/dev/reports/schema_strictness_inventory.md` and `.csv` listing every schema object that allows unknown fields.
...
- detailed CSV reports under `docs/dev/reports/`
...
- Reports are written to `docs/dev/reports/`.
