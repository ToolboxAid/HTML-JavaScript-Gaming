...
- `docs/dev/**`
- `docs/dev/reports/**`
- `docs/dev/roadmaps/MASTER_ROADMAP_ENGINE.md` status markers only, if an existing matching roadmap item is found
...
```text
docs/dev/reports/pr_11_188_palette_manager_reverse_engineering.md
```
