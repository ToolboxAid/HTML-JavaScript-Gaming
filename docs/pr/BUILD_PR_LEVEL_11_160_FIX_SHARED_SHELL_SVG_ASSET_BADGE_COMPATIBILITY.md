...
The latest delta changed `tools/shared/platformShell.js`, which means the active visible badge path is in the shared shell, not Workspace Manager.
...
In `tools/shared/platformShell.js`, inspect:
