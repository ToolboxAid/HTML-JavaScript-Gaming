...
## Goal
Build a brand-new browser Sprite Editor from scratch as an isolated tool under `tools/SpriteEditorV3/`.
...
- New isolated tool in `tools/SpriteEditorV3/`
...
## Validation gates
- Tool opens directly in browser from `tools/SpriteEditorV3/index.html`
