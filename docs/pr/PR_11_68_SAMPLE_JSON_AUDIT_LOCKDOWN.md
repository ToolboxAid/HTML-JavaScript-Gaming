...
- Preserve CSV report generation at `docs/dev/reports/sample_json_js_reference_audit.csv`.
...
7. Add a short report at `docs/dev/reports/PR_11_68_sample_json_audit_lockdown_report.md` with:
   - before counts
   - after counts
