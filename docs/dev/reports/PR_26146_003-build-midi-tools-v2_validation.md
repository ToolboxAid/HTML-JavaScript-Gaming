...
- Playwright V8 coverage: generated advisory report at `docs/dev/reports/playwright_v8_coverage_report.txt`; changed runtime JS files are reported as WARN/uncovered because Chromium could not launch.
