...
1. `docs/dev/reports/svg_payload_to_shared_asset_badge_11_161.txt`
- Reason: empty file (`0` bytes)
- Ledger class: `REVERT`

2. `docs/dev/reports/pr_11_162_evidence_template.txt`
- Reason: template-only placeholder; not execution evidence
- Ledger class: `REVERT`

3. `docs/dev/reports/pr_11_163_delivery_manifest.md`
...
- `docs/pr/BUILD_PR_LEVEL_11_155_TRACE_SVG_ASSET_NONE_SOURCE.md`
- `docs/pr/BUILD_PR_LEVEL_11_156_INSTRUMENT_SVG_CARD_RENDER_SOURCE.md`
- `docs/pr/BUILD_PR_LEVEL_11_157_FIX_WORKSPACE_TILE_SUMMARY_DISPLAY_MODEL.md`
- `docs/pr/BUILD_PR_LEVEL_11_158_FORCE_FIX_LITERAL_ASSET_NONE_RENDERER.md`
...
- `docs/pr/PR_11_164_DEAD_CODE_LEDGER_AND_REVERT_MAP.md`
...
- `docs/dev/reports/pr_11_163_handoff_trace_report.md`
