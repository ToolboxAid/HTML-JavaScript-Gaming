...
| File Path | Classification | Reason | Recommended Action | Risk | Required |
| --- | --- | --- | --- | --- | --- |
| `docs/dev/reports/lane_manifests/workspace-contract.json` | already lane-safe | Persisted manifest names one Workspace spec, 13 explicit fixtures, and 4 helpers. | Keep generated artifact; regenerate through targeted runner. | Low | No |
| `docs/dev/reports/lane_manifests/tool-runtime.json` | already lane-safe | Persisted manifest names 3 tool specs, 4 explicit fixtures, and 4 helpers. | Keep generated artifact; split physical tool specs separately. | Low | No |
| `docs/dev/reports/lane_manifests/game-runtime.json` | already lane-safe | Persisted manifest names 4 game specs, 1 fixture, and 3 helpers. | Keep generated artifact. | Low | No |
| `docs/dev/reports/lane_manifests/integration.json` | already lane-safe | Persisted manifest names 1 integration spec, 1 fixture, and 4 helpers. | Keep generated artifact; split broad all-game test from physical spec later. | Low | No |
| `docs/dev/reports/lane_manifests/engine-src.json` | already lane-safe | Persisted manifest names 11 targeted Node tests and no browser helpers/fixtures. | Keep generated artifact. | Low | No |
| `docs/dev/reports/lane_snapshots/*.json` | already lane-safe | Snapshot files mirror lane ownership metadata and dependency graph hashes. | Keep generated artifacts; regenerate when lane inputs change. | Low | No |
| `docs/dev/reports/lane_warm_starts/*.json` | already lane-safe | Warm-start files are lane-scoped and versioned. | Keep generated artifacts. | Low | No |
