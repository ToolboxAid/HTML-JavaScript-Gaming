...
- Renamed `tools/templates-v2` to `tools/_templates-v2`.
- Added `tools/audio-sfx-playground-v2`.
...
3. Open `/tools/workspace-manager-v2/index.html?workspace=uat`.
4. Click `Seed UAT Manifest`.
5. Confirm the `Audio / SFX Playground V2` tile appears and is ready to launch.
6. Click the tile and confirm `/tools/audio-sfx-playground-v2/index.html` opens with `launch=workspace`.
