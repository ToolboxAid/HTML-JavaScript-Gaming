...
- Rebuilt `docs/dev/roadmaps/MASTER_ROADMAP_TOOLS.md` so Palette Browser starts first, non-transitional tools follow, transitional cleanup comes later, and samples remain deferred.
