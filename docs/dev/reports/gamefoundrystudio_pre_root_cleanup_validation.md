...
- `docs/dev/PROJECT_INSTRUCTIONS.md` was updated with the GameFoundryStudio North Star / `Build · Play · Share` guidance requested by the PR.
...
- `node --check GameFoundryStudio\assets\js\account-controls.js`
  - Result: Passed.
- `git diff --check -- GameFoundryStudio docs\dev\PROJECT_INSTRUCTIONS.md`
  - Result: Passed.
