...
- `docs/dev/reports/input_mapping_v2_capture_device_gesture_flow_report.md`
...
- `docs/dev/reports/playwright_v8_coverage_report.txt` was refreshed by the Workspace V2 Playwright run.
