...
- Added Theme Surface Boundary guidance to docs/dev/PROJECT_INSTRUCTIONS.md.
...
## Validation Commands
- rg -n "Theme Surface Boundary|GameFoundryStudio/assets/css/theme/v2|src/engine/theme|Do not deprecate src/engine/theme|Collapse/rail behavior currently belongs only" docs/dev/PROJECT_INSTRUCTIONS.md
- git diff -- docs/dev/PROJECT_INSTRUCTIONS.md
...
- git diff --check -- docs/dev/PROJECT_INSTRUCTIONS.md
- git diff --check HEAD~1 HEAD -- docs/dev/PROJECT_INSTRUCTIONS.md
...
PASS - Theme Surface Boundary section exists in docs/dev/PROJECT_INSTRUCTIONS.md.
PASS - Boundary section names both GameFoundryStudio/assets/css/theme/v2 and src/engine/theme ownership.
PASS - HEAD~1..HEAD changed only docs/dev/PROJECT_INSTRUCTIONS.md.
PASS - No CSS files changed.
PASS - No HTML files changed.
PASS - No JavaScript files changed.
PASS - No GameFoundryStudio page files changed outside docs/dev/PROJECT_INSTRUCTIONS.md.
PASS - No Tools, Admin, Account, Company, Games, Samples, or root index page migration files changed.
PASS - git diff --check passed for docs/dev/PROJECT_INSTRUCTIONS.md and HEAD~1..HEAD.
