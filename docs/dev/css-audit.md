...
- Added `GameFoundryStudio/assets/css/colors.css` as the CSS color source of truth.
- Added `GameFoundryStudio/assets/css/tokens.css` for non-color design tokens.
- Removed per-color CSS files under `GameFoundryStudio/assets/css/colors/`.
