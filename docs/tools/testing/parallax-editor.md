# Parallax Scene Studio Testing Guide
...
## Purpose Of Testing
Parallax scene composition and sample handoff workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Parallax Scene Studio`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Parallax Scene Studio/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Saved parallax scene package can be loaded by sample scene playback surfaces.
