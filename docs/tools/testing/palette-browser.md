# Palette Browser / Manager Testing Guide
...
## Purpose Of Testing
Palette management and shared palette contract workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Palette Browser / Manager`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Palette Browser/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Palette selections are consumable by tools and runtime palette consumers.
