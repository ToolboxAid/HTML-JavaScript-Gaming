# Performance Profiler Testing Guide
...
## Purpose Of Testing
Frame/performance metrics review workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Performance Profiler`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Performance Profiler/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Profiler summary aligns with runtime frame cadence/perf payload schema.
