...
## Purpose Of Testing
Physics parameter experimentation and deterministic preview workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Physics Sandbox`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Physics Sandbox/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Scenario parameters/results map to shared physics helper expectations.
