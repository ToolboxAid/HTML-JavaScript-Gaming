...
## Purpose Of Testing
Tile map layering, simulation, and packaging workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Tilemap Studio`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Tilemap Studio/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Saved tile map package can be loaded by sample playback/simulation surfaces.
