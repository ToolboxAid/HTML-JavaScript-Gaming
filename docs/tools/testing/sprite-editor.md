...
## Purpose Of Testing
Sprite-sheet editing, frame workflows, and palette-bound output.
...
## Setup Steps
1. Open `tools/index.html` and launch `Sprite Editor`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Sprite Editor/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Sprite output can be consumed by runtime sprite loading/palette-aware render surfaces.
