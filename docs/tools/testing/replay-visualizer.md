# Replay Visualizer Testing Guide
...
## Purpose Of Testing
Replay timeline review and frame-step verification workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Replay Visualizer`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Replay Visualizer/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Replay data loaded by tool matches runtime event stream contract.
