# Tile Model Converter Testing Guide
...
## Purpose Of Testing
Tile/vector conversion request and output verification workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Tile Model Converter`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Tile Model Converter/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Converted output artifacts are valid for target importer/runtime contract.
