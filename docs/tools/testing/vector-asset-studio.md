# Vector Asset Studio Testing Guide
...
## Purpose Of Testing
Vector asset authoring and export contract workflows.
...
## Setup Steps
1. Open `tools/index.html` and launch `Vector Asset Studio`.
...
## Smoke Tests
1. Launch the tool directly via `tools/Vector Asset Studio/index.html` and verify first paint in under expected local baseline.
...
4. Integration handoff: Exported vector asset package is consumable by shared asset/runtime surfaces.
