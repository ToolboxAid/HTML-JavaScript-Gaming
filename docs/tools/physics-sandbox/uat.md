# Physics Sandbox — UAT (User Acceptance Validation)

## Purpose
Validate that the Physics Sandbox meets user expectations for primary workflows, stability, and acceptance readiness.
