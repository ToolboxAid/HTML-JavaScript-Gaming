...
- Source: toolbox/SpriteEditor_old_keep/modules/
- Target: toolbox/SpriteEditor_old_keep/shared/ (NOT engine)
...
## Extraction Rules
- Move helper to: toolbox/SpriteEditor_old_keep/shared/<helperName>.js
