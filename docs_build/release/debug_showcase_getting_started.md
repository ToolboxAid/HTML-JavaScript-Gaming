...
## URL Patterns
- Play: `/old_games/<Sample>/index.html`
- Debug: `/old_games/<Sample>/index.html?debug=1`
- Optional Demo (if enabled in sample): `/old_games/<Sample>/index.html?debugDemo=1`
