...
- docs_build/operations/dev/PROJECT_INSTRUCTIONS.md = ChatGPT operating instructions
...
Use docs_build/operations/dev/PROJECT_INSTRUCTIONS.md as system instructions.

Current task:
<PLAN_PR or BUILD_PR name>

## Codex Command
Use the template in docs_build/operations/dev/templates/CODEX_AUTO_COMMAND.md
