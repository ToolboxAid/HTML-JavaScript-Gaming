...
Use this block in every BUILD PR `docs_build/operations/dev/codex_commands.md`.
...
- Do not modify `docs_build/dev/start_of_day/chatGPT/`
- Do not modify `docs_build/dev/start_of_day/codex/`
