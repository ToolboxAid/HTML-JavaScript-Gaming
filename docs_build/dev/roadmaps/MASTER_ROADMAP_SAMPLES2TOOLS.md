...
- [x] `docs_build/dev/reports/samples2tools_batch_<n>_summary.txt`
- [x] `docs_build/dev/reports/samples2tools_batch_<n>_validation.txt`
- [x] `docs_build/dev/reports/samples2tools_link_map_<n>.json`
- [x] `docs_build/dev/reports/samples2tools_completion_report.txt` (final completion artifact)
- [x] `docs_build/dev/reports/games2tools_roundtrip_validation.txt`
- [x] `docs_build/dev/reports/games2tools_manual_qa_checklist.txt`
- [x] `docs_build/dev/reports/games2tools_roundtrip_matrix.txt`
