...
Changed:
- `docs_build/dev/specs/IDENTITY_PERMISSIONS_MODEL.md`
...
- `git diff --check -- docs_build/dev/specs/IDENTITY_PERMISSIONS_MODEL.md`
- `git status --short -uall`
- `git diff --name-only -- "*.css" "*.html" "*.js" "*.ts" "*.json"`

Results:
- PASS: `docs_build/dev/specs/IDENTITY_PERMISSIONS_MODEL.md` exists.
