...
1. Open `toolbox/index.html`.
   ...
   - Expected: Workspace Manager V2 opens `/toolbox/workspace-manager-v2/index.html`.
2. Open `toolbox/workspace-manager-v2/index.html`.
