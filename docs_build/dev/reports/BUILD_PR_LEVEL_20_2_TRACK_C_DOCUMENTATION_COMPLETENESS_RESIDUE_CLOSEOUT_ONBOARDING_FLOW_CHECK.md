...
| workflow rules | `docs_build/operations/dev/README.md` | PASS |
| project instructions | `docs_build/operations/dev/PROJECT_INSTRUCTIONS.md` | PASS |
| master roadmap | `docs_build/dev/roadmaps/MASTER_ROADMAP_ENGINE.md` | PASS |
...
| tool scripting docs | `docs_build/operations/dev/CODEX_WEBSITE_REPO_DEPLOYMENT_SCRIPTING.md` | PASS |
| tool path rules | `docs_build/operations/dev/POWERSHELL_SCRIPT_STRUCTURE.md` | PASS |
| capability PR index | `docs_build/pr/capabilities/README.md` | PASS |
