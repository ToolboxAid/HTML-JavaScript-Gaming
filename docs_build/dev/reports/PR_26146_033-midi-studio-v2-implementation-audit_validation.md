...
- `docs_build/dev/reports/PR_26146_033-midi-studio-v2-implementation-audit_validation.md`
...
6. Read `docs_build/dev/reports/PR_26146_033-midi-studio-v2-implementation-audit.md` and verify UNKNOWN items are not claimed as complete.
