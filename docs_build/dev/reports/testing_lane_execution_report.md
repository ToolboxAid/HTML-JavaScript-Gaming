...
Generated: 2026-06-12T16:15:52.104Z
Dry run: No
...
FAIL: 0
SKIP: 14
Total lane elapsed time: 48.48s
...
| Lane | Duration | Test |
| --- | --- | --- |
| workspace-contract | 12.20s | tests\playwright\tools\RootToolsFutureState.spec.mjs:360:1 > learn wireframe pages load with shared Theme V2 structure |
| workspace-contract | 10.60s | tests\playwright\tools\RootToolsFutureState.spec.mjs:460:1 > representative active tool pages align center cleanup and registry group colors |
...
| workspace-contract | 7.40s | tests\playwright\tools\RootToolsFutureState.spec.mjs:282:1 > common header renders primary navigation order across active pages |
