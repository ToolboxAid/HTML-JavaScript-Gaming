...
Generated: 2026-06-08T05:42:33.348Z
Dry run: No
...
FAIL: 0
SKIP: 14
Total lane elapsed time: 49.24s
...
| Lane | Duration | Test |
| --- | --- | --- |
| workspace-contract | 11.70s | tests\playwright\tools\RootToolsFutureState.spec.mjs:76:1 > root tools surface links current tool pages without old_* routes |
| workspace-contract | 10.90s | tests\playwright\tools\RootToolsFutureState.spec.mjs:376:1 > learn wireframe pages load with shared Theme V2 structure |
| workspace-contract | 10.40s | tests\playwright\tools\RootToolsFutureState.spec.mjs:476:1 > representative active tool pages align center cleanup and registry group colors |
| workspace-contract | 7.10s | tests\playwright\tools\RootToolsFutureState.spec.mjs:298:1 > common header renders primary navigation order across active pages |
| workspace-contract | 1.50s | tests\playwright\tools\RootToolsFutureState.spec.mjs:454:1 > tool template future-state page loads from root Theme V2 paths |
