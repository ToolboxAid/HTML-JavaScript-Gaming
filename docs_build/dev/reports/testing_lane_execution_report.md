...
Generated: 2026-06-16T16:27:15.795Z
Dry run: No
...
FAIL: 0
SKIP: 14
Total lane elapsed time: 77.89s
...
| Lane | Duration | Test |
| --- | --- | --- |
| workspace-contract | 42.00s | tests\playwright\tools\RootToolsFutureState.spec.mjs:630:1 > representative active tool pages align center cleanup and registry group colors |
| workspace-contract | 10.20s | tests\playwright\tools\RootToolsFutureState.spec.mjs:246:1 > root tools surface links current tool pages without old_* routes |
...
| workspace-contract | 6.80s | tests\playwright\tools\RootToolsFutureState.spec.mjs:452:1 > common header renders primary navigation order across active pages |
