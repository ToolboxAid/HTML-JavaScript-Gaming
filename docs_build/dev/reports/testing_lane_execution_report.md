...
Generated: 2026-06-12T15:51:29.229Z
Dry run: No
...
FAIL: 0
SKIP: 14
Total lane elapsed time: 47.60s
...
| Lane | Duration | Test |
| --- | --- | --- |
| workspace-contract | 11.00s | tests\playwright\tools\RootToolsFutureState.spec.mjs:76:1 > root tools surface links current tool pages without old_* routes |
...
| workspace-contract | 9.60s | tests\playwright\tools\RootToolsFutureState.spec.mjs:460:1 > representative active tool pages align center cleanup and registry group colors |
