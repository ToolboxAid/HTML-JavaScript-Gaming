...
- Read `docs_build/dev/PROJECT_INSTRUCTIONS.md` and `tmp/dups.txt`.
...
- Advisory Playwright V8 coverage refreshed in `docs_build/dev/reports/playwright_v8_coverage_report.txt` and `docs_build/dev/reports/coverage_changed_js_guardrail.txt`.
