...
- PASS: `rg -n "ai-assistant|assets/css/theme/v2/theme\.css|assets/js/gamefoundry-partials\.js|assets/js/tool-display-mode\.js|data-tool-display-mode|assets/images/tools/ai-assistant\.png|assets/images/badges/ai-assistant\.png|\.\./tools/ai-assistant\.html|rootPageRoutes" toolbox/ai-assistant.html toolbox/index.html GameFoundryStudio/assets/js/tools-page-accordions.js GameFoundryStudio/assets/js/gamefoundry-partials.js`
  ...
  - Tools index data points the AI Assistant tile to root `/toolbox/ai-assistant.html`.
...
- PASS: `rg -n "assets/images/tools/ai-assistant\.png|assets/images/badges/ai-assistant\.png|assets/images/characters/ai-assistant\.png" GameFoundryStudio/assets/js/tool-display-mode.js toolbox/ai-assistant.html GameFoundryStudio/assets/js/tools-page-accordions.js`
...
- Root Tools index data now uses:
  - `../toolbox/ai-assistant.html`
- From `/toolbox/index.html` with `<base href="../GameFoundryStudio/">`, that link resolves to root `/toolbox/ai-assistant.html`.
- Shared partial route map still maps:
  - `ai-assistant` -> `toolbox/ai-assistant.html`
- `ai-assistant` is included in `rootPageRoutes`, so shared nav rewrites that route to root `/toolbox/ai-assistant.html` from migrated root pages.

## Asset and JS Validation

- `toolbox/ai-assistant.html` loads:
  - `assets/css/theme/v2/theme.css`
  - `assets/js/gamefoundry-partials.js`
  - `assets/js/tool-display-mode.js`
- `toolbox/ai-assistant.html` references:
