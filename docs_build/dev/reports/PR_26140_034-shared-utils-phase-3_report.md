...
## Coverage
- Produced advisory Playwright V8 coverage artifacts at `docs_build/dev/reports/playwright_v8_coverage_report.txt` and `docs_build/dev/reports/coverage_changed_js_guardrail.txt`.
