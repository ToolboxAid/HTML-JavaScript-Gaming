...
- Restored missing sorting and grouping behavior on root `/toolbox/index.html`.
...
- PASS: `rg -n "assets/css/theme/v2|<link rel=\"stylesheet\"|tools-page-accordions\.js|data-tools-accordion-list" toolbox/index.html`
