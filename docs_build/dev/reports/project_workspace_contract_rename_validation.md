...
- Added `docs_build/dev/specs/PROJECT_WORKSPACE_RUNTIME_CONTRACT.md`.
- Updated `docs_build/dev/specs/TOOL_LAUNCH_SSOT.md` to use ProjectWorkspace terminology for prior runtime launch state.
...
```powershell
git diff --check -- src/shared/contracts tests/shared docs_build/dev/specs docs_build/dev/reports/project_workspace_contract_rename_validation.md docs_build/dev/commit_comment.txt
...
rg -P "^# Workspace|^- Workspace|^Workspace(?! Manager)|^- workspace|^workspace" -n src/shared/contracts/projectWorkspaceRuntimeContract.js tests/shared/ProjectWorkspaceRuntimeContract.test.mjs docs_build/dev/specs/PROJECT_WORKSPACE_RUNTIME_CONTRACT.md docs_build/dev/specs/TOOL_LAUNCH_SSOT.md docs_build/dev/reports/project_workspace_contract_rename_validation.md
