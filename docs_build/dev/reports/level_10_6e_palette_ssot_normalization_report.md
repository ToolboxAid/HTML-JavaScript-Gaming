...
- Before (from prior evidence capture report/run):
  ...
  - Artifact: `docs_build/dev/reports/level_10_6d_palette_contract_evidence/test_sample_standalone_data_flow_output.txt`
- After (this BUILD):
  ...
  - swatchCount: `5`
  - Artifact: `docs_build/dev/reports/level_10_6e_sample_standalone_data_flow_output.txt`
...
- Artifact: `docs_build/dev/reports/level_10_6e_launch_smoke_games_output.txt`
...
- `docs_build/dev/reports/level_10_6e_sample_standalone_data_flow_output.txt`
- `docs_build/dev/reports/level_10_6e_launch_smoke_games_output.txt`
- `docs_build/dev/reports/launch_smoke_report.md` (updated by required launch-smoke test run)
