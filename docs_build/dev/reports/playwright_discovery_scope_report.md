...
Generated: 2026-06-05T12:42:54.983Z
Status: PASS
...
| --- | --- | --- | --- |
| target spec | tests/playwright/tools/BuildPathProgressSimplification.spec.mjs | PASS | Explicit target is inside the selected discovery lane scope. |
