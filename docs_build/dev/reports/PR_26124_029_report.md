...
## Sort Note
- Existing archive confirmed a prior palette sort set of Name, Hue, Saturation, and Lightness in `archive/v1-v2/docs_build/archive/tools/SpriteEditor_old_keep/modules/controlSurfaceRightPanel.js`.
