...
- Baseline: `3f7e9df`
- HEAD: `5e5e5f12`
- Rules source: `docs_build/dev/codex_rules.md`
...
- File:
  - `docs_build/dev/start_of_day/codex/PROJECT_INSTRUCTIONS.lnk` (`A` after baseline)
- Why this is an anti-pattern:
...
- Evidence:
  - Added `docs_build/dev/roadmaps/MASTER_ROADMAP_SAMPLES2TOOLS.md` after baseline.
