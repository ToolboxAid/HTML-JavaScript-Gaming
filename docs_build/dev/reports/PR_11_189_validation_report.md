...
- `docs_build/pr/BUILD_PR_11_189_SVG_ASSET_STUDIO_V2.md`
- `docs_build/pr/PLAN_PR_11_189_SVG_ASSET_STUDIO_V2.md`
...
Command:
```powershell
rg -n "SVG Asset Studio v2|SVG v2|Tool v2|svg-asset-studio-v2|SVG Asset Studio" "docs_build/dev/roadmaps/MASTER_ROADMAP_ENGINE.md"
```
