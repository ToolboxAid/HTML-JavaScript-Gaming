...
### 1) `git status --short`
```text
 M docs_build/dev/codex_rules.md
 M docs_build/operations/dev/codex_commands.md
 M docs_build/operations/dev/commit_comment.txt
?? docs_build/dev/reports/recovery_antipattern_audit_from_20_1.md
?? docs_build/dev/reports/recovery_change_audit_from_20_1.md
?? docs_build/dev/reports/recovery_file_risk_list_from_20_1.md
?? docs_build/dev/reports/recovery_reset_decision_from_20_1.md
?? docs_build/pr/BUILD_PR_LEVEL_20_5_RECOVERY_AUDIT_FROM_20_1_BASELINE.md
```
