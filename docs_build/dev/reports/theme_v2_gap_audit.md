...
- Theme V2 audit report exists at `docs_build/dev/reports/theme_v2_gap_audit.md`.
- `docs_build/dev/PROJECT_INSTRUCTIONS.md` contains `### Theme V2 Consolidation Rule`.
