...
| game-runtime | SKIP | Deprecated old_games reference coverage | none | none | Lane was not selected. |
...
| samples | PASS | Deprecated old_samples reference coverage | none | none | Lane graph, command shape, targets, fixtures, and ownership compile before runtime. |
