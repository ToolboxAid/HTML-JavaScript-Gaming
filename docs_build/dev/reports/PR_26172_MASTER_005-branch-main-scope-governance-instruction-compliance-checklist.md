# PR_26172_MASTER_005 Instruction Compliance Checklist
...
- PASS: Branch name mirrors PR ownership: `pr/26172-MASTER-005-branch-main-scope-governance`.
...
- PASS: Required ZIP path is `tmp/PR_26172_MASTER_005-branch-main-scope-governance_delta.zip`.
