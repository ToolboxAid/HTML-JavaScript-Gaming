...
Team: Charlie
GitHub PR: #221
Branch: PR_26177_CHARLIE_011-sprites-tool-shell
Base: main
...
| --- | --- | --- |
| One PR purpose only | PASS | Adds the Sprites Toolbox shell using Theme V2/table-first layout and connects read/list to the API contract. |
