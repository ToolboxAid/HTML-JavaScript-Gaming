...
- Source of truth: user PR request. `docs_build/pr/BUILD_PR.md` was checked and is for a different overlay runtime hardening task, so it was not used for implementation scope.
