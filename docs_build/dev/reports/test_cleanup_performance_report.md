...
Total measured lane elapsed time: 11.29s
...
| --- | --- | --- | --- | --- |
| workspace-contract | PASS | 11.29s | 1 | Workspace V2 command now validates the future-state tools surface without exercising deprecated tools/old_* routes. |
