...
Total measured lane elapsed time: 10.21s
...
| --- | --- | --- | --- | --- |
| workspace-contract | PASS | 10.21s | 1 | Workspace V2 command now validates the future-state tools surface without exercising deprecated toolbox/old_* routes. |
