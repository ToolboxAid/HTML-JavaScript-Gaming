...
This DoD applies to tools opened from `archive/v1-v2/games/index.html`, `samples/index.html`, Workspace Manager, and any sample/game manifest-driven launch.
...
```text
docs_build/dev/reports/level_10_6Q_tool_ui_readiness_dod_completion_report.md
```
