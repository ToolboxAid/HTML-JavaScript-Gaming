...
## Scope
Included:
- audit fragmented PR/doc capability history in `docs_build/pr/`
...
- `docs_build/dev/reports/BUILD_PR_LEVEL_18_20_TRACK_H_PR_CONSOLIDATION_EXECUTION_FRAGMENTATION_AUDIT.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_18_20_TRACK_H_PR_CONSOLIDATION_EXECUTION_CAPABILITY_GROUPS.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_18_20_TRACK_H_PR_CONSOLIDATION_EXECUTION_CONSOLIDATION_MAP.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_18_20_TRACK_H_PR_CONSOLIDATION_EXECUTION_VALIDATION.md`
- `docs_build/dev/templates/pr_capability_bundle_checklist.md`

Capability review surfaces to create/update as needed:
- `docs_build/pr/capabilities/`...
- or another clearly named capability-level folder under `docs_build/pr/`

## Execution details

### 1) Fragmentation audit
Audit `docs_build/pr/` and identify clusters where one capability is split across many small PR docs.
