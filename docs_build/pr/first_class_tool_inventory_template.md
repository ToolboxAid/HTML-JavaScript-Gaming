...
|---|---|---|---|---|---|---|---|
| 1 | palette-browser | Palette Browser | toolbox/palette-browser | src/shared/schemas/tools/palette-browser.schema.json | yes | palette | |
| 2 | sprite-editor | Sprite Editor | toolbox/sprite-editor | src/shared/schemas/tools/sprite-editor.schema.json | yes | sprite/palette | |
| 3 | vector-map-editor | Vector Map Editor | toolbox/vector-map-editor | src/shared/schemas/tools/vector-map-editor.schema.json | yes | map/palette | |
| 4 | vector-asset-studio | Vector Asset Studio | toolbox/vector-asset-studio | src/shared/schemas/tools/vector-asset-studio.schema.json | yes | vector assets | |
