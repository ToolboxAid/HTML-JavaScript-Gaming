...
### 2) Rule-Move Guards
- Added `## Roadmap Instruction Move Guards` in `docs_build/operations/dev/PROJECT_INSTRUCTIONS.md` with explicit rules:
...
- Confirmed move-guard rules now exist in `docs_build/operations/dev/PROJECT_INSTRUCTIONS.md`.
