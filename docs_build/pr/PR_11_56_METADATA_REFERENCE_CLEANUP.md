...
1. Run:
   ...
   ```
2. Save before counts in `docs_build/dev/reports/pr_11_56_before_audit.txt`.
...
8. Re-run audit and save after counts in `docs_build/dev/reports/pr_11_56_after_audit.txt`.
