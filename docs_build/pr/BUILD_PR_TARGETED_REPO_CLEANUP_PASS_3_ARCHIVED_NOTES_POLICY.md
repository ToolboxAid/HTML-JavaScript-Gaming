...
Create `docs_build/reports/archived_notes_policy_decision.md`.
...
Create `docs_build/reports/archived_notes_validation_guard.md`.
...
### 5) BUILD report
Create `docs_build/reports/BUILD_PR_TARGETED_REPO_CLEANUP_PASS_3_ARCHIVED_NOTES_POLICY_report.md` with:
