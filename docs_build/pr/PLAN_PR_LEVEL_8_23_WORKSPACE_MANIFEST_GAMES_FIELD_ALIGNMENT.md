...
## Purpose
Fix the remaining Level 8 schema conformance blocker: workspace manifest documents are missing the root `games` field required by `src/shared/schemas/workspace.schema.json`.
