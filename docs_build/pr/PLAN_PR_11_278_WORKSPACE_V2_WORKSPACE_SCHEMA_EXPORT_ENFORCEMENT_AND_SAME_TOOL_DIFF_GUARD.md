...
## Purpose
Enforce Workspace V2 workspace export/import against `src/shared/schemas/workspace.schema.json` and block cross-tool session diff comparisons.

## Scope
- toolbox/workspace-v2/index.html
- toolbox/workspace-v2/index.js
- src/shared/schemas/workspace.schema.json (smallest required addition only)
