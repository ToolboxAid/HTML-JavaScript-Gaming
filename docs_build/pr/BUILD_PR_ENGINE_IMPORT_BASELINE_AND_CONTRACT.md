...
- `docs_build/reports/engine_import_baseline_report.md`
- `docs_build/reports/engine_import_contract_decision.md`
- `docs_build/reports/BUILD_PR_ENGINE_IMPORT_BASELINE_AND_CONTRACT_report.md`
...
### 1) Baseline report
Create `docs_build/reports/engine_import_baseline_report.md`.
...
### 2) Contract decision
Create `docs_build/reports/engine_import_contract_decision.md`.
...
### 4) BUILD report
Create `docs_build/reports/BUILD_PR_ENGINE_IMPORT_BASELINE_AND_CONTRACT_report.md` with:
- bundle type
- exact files created
- exact files changed
- summary of findings
...
Create `docs_build/reports/validation_checklist.txt` with pass/fail for:
