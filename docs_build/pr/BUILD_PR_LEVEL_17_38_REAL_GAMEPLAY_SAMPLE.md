...
## Source of Truth
- `docs_build/pr/PLAN_PR_LEVEL_17_38_REAL_GAMEPLAY_SAMPLE.md`
- `docs_build/dev/roadmaps/MASTER_ROADMAP_ENGINE.md` (`## 17. 3D Activation, Validation, and Execution (Phase 16)`)
