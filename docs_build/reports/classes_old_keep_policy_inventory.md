...
- `docs/reference/features/docs-system/move-history-preserved.md`
- `docs_build/reports/cleanup_target_normalization_report.md` (tracking context)
- `docs_build/reports/cleanup_target_enforcement_map.md` (tracking context)

### Roadmap
- `docs_build/dev/roadmaps/MASTER_ROADMAP_ENGINE.md` (`legacy class-retention policy marker` policy tracking item)

### PR / BUILD Spec
- `docs_build/pr/BUILD_PR_REPO_CLEANUP_AND_ROADMAP_UPDATE.md` (historical cleanup evidence lane)
- `docs_build/pr/BUILD_PR_TARGETED_REPO_CLEANUP_PASS_5_CLASSES_OLD_KEEP_POLICY_PS_FIRST.md` (this lane)

### Generated Command Metadata (From User-Supplied Scan Context)
- `docs_build/dev/CODEX_COMMANDS.md`
- `docs_build/dev/NEXT_COMMAND.txt`
- generated report metadata surfaces under `docs_build/dev/reports/`
