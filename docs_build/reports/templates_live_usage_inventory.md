...
- `docs_build/pr/PLAN_PR_REPO_CLEANUP_AND_ROADMAP_UPDATE.md`
- Additional active report/planning docs under `docs_build/dev/reports/` and `docs_build/pr/` that cite template cleanup constraints.
