import Entity from '../../../engine/v2/entity/Entity.js';
import Transform from '../../../engine/v2/entity/Transform.js';
import Velocity from '../../../engine/v2/entity/Velocity.js';
import Bounds from '../../../engine/v2/entity/Bounds.js';
...
export function run() {
    ...
    assert(entity.transform.position.x === 10, 'clampCenter should clamp x inside area.');
