...
test("toolbox index shows wireframe and beta tools while Planned remains opt-in", async ({ page }) => {
  ...
  try {
    ...
    await expect(page.locator("[data-toolbox-tool-name-link='Sprites']")).toHaveAttribute("href", "/toolbox/sprites/index.html");
    await expect(page.locator("[data-toolbox-tool-card='Sprites']")).toHaveAttribute("data-toolbox-release-channel", "wireframe");
    await expect(page.locator("[data-toolbox-tool-card='Sprites'] [data-toolbox-tile-action-row='Sprites'] a.btn")).toHaveText("Open Tool");
