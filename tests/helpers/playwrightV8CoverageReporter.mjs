...
export class PlaywrightV8CoverageReporter {
  constructor({
    ...
    reportPath = "dev/docs_build/dev/reports/playwright_v8_coverage_report.txt",
    guardrailReportPath = "dev/docs_build/dev/reports/coverage_changed_js_guardrail.txt",
