...
} from "../../toolbox/shared/runtimeSceneLoaderHotReload.js";
import {
  ASSET_DOCUMENT_TYPE,
...
function createFixtureDocuments() {
  ...
  return {
    ...
    documentsByPath: {
      ...
      "scenes/vector.asset.json": createAssetDocument("object-vector-studio-v2", "doc.vector", "vector", "assets/vector/overlay.svg", 3)
    }
  };
}
...
export async function runRuntimeSceneLoaderHotReloadValidation() {
