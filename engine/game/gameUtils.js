...
class GameUtils {
    ...
    static getPlayerSelectConfig(canvasConfig, playerSelect = {}) {
        return {
            ...
            fillText: playerSelect.fillText ?? playerSelect.title ?? DEFAULT_PLAYER_SELECT_CONFIG.fillText,
            x: playerSelect.optionBaseX ?? playerSelect.x ?? DEFAULT_PLAYER_SELECT_CONFIG.x,
            y: playerSelect.optionBaseY ?? playerSelect.y ?? DEFAULT_PLAYER_SELECT_CONFIG.y,
            spacing: playerSelect.optionSpacing ?? playerSelect.spacing ?? DEFAULT_PLAYER_SELECT_CONFIG.spacing,
            fillStyle: playerSelect.fillStyle ?? playerSelect.color ?? DEFAULT_PLAYER_SELECT_CONFIG.fillStyle,
