...
// David Quesenberry
// 03/19/2026
// gamePlayerSelectionUtils.js
//
// PR-011 boundary note:
// - gameplay-facing player-selection utility boundary
// - extracted from GameUtils as the first real gameplay-facing split
// - owns player-selection config, selection result shaping, keyboard/controller selection,
//   controller warning behavior, and selection resolution flow
...
class GamePlayerSelectionUtils {
    ...
    constructor() {
        throw new Error('GamePlayerSelectionUtils is a utility class with only static methods. Do not instantiate.');
    }
}

export default GamePlayerSelectionUtils;
