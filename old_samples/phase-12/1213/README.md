...
# Sample 1213 - Vector Map Dungeon Layout Preset

Sample-local contract for `old_samples/phase-12/1213`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1213/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1213` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1213/assets/images`.
...
```text
old_samples/phase-12/1213/index.html
old_samples/phase-12/1213
1213
```
