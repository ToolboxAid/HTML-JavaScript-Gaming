...
Sample-local contract for `old_samples/phase-12/1206`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1206/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1206` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1206/assets/images`.
...
```text
old_samples/phase-12/1206/index.html
old_samples/phase-12/1206
1206
```
