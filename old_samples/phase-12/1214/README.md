...
# Sample 1214 - Vector Map Arena Zone Preset

Sample-local contract for `old_samples/phase-12/1214`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1214/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1214` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1214/assets/images`.
...
```text
old_samples/phase-12/1214/index.html
old_samples/phase-12/1214
1214
```
