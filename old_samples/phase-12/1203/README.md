...
Sample-local contract for `old_samples/phase-12/1203`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1203/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1203` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1203/assets/images`.
...
```text
old_samples/phase-12/1203/index.html
old_samples/phase-12/1203
1203
```
