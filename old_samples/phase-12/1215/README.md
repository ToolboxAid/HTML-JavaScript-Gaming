...
# Sample 1215 - Vector Asset Sky Gradient Preset

Sample-local contract for `old_samples/phase-12/1215`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1215/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1215` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1215/assets/images`.
...
```text
old_samples/phase-12/1215/index.html
old_samples/phase-12/1215
1215
```
