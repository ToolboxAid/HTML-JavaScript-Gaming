...
# Sample 1220 - Parallax Mario Learning Preset

Sample-local contract for `old_samples/phase-12/1220`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1220/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1220` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1220/assets/images`.
...
```text
old_samples/phase-12/1220/index.html
old_samples/phase-12/1220
1220
```
