...
# Sample 1216 - Vector Asset Mountain Range Preset

Sample-local contract for `old_samples/phase-12/1216`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1216/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1216` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1216/assets/images`.
...
```text
old_samples/phase-12/1216/index.html
old_samples/phase-12/1216
1216
```
