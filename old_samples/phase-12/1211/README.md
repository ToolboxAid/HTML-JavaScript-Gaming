...
# Sample 1211 - Tilemap Mario Learning Layout Preset

Sample-local contract for `old_samples/phase-12/1211`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1211/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1211` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1211/assets/images`.
...
```text
old_samples/phase-12/1211/index.html
old_samples/phase-12/1211
1211
```
