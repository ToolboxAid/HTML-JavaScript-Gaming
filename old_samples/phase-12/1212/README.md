...
# Sample 1212 - Vector Map Overworld Route Preset

Sample-local contract for `old_samples/phase-12/1212`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1212/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1212` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1212/assets/images`.
...
```text
old_samples/phase-12/1212/index.html
old_samples/phase-12/1212
1212
```
