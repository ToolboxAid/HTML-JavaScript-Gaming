...
# Sample 1219 - Parallax Tilemap Embedded Preset

Sample-local contract for `old_samples/phase-12/1219`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1219/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1219` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1219/assets/images`.
...
```text
old_samples/phase-12/1219/index.html
old_samples/phase-12/1219
1219
```
