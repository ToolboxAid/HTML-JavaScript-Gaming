...
Sample-local contract for `old_samples/phase-14/1411`.

## Implementation Location

- Entrypoint: `old_samples/phase-14/1411/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-14/1411` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-14/1411/assets/images`.
...
```text
old_samples/phase-14/1411/index.html
old_samples/phase-14/1411
1411
```
