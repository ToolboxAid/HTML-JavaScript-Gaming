...
# Sample 1506 - Scene Graph / Entity Hierarchy Viewer

Sample-local contract for `old_samples/phase-15/1506`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1506/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1506` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-15` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1506/assets/images`.
...
```text
old_samples/phase-15/1506/index.html
old_samples/phase-15/1506
1506
```
