...
# Sample 1505 - Asset Browser

Sample-local contract for `old_samples/phase-15/1505`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1505/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1505` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1505/assets/images`.
...
```text
old_samples/phase-15/1505/index.html
old_samples/phase-15/1505
1505
```
