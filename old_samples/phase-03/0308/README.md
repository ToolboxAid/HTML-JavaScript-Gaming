...
# sample 0308 - Gravity Zones

Sample-local contract for `old_samples/phase-03/0308`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0308/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0308` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0308/assets/images`.
...
```text
old_samples/phase-03/0308/index.html
old_samples/phase-03/0308
0308
```
...
# Sample 056 - Gravity Zones

## Purpose
Demonstrates directional gravity fields using authored world rectangles.

## Controls
Arrow keys or WASD to add thrust and move between zones.
Press Space to jump opposite the current gravity direction.

## Notes
This sample intentionally keeps jump local to Sample 056.
It is a simple first pass so raised blocks in this sample are reachable.
