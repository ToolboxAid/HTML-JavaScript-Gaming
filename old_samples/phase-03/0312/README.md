...
Sample-local contract for `old_samples/phase-03/0312`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0312/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0312` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0312/assets/images`.
...
```text
old_samples/phase-03/0312/index.html
old_samples/phase-03/0312
0312
```
