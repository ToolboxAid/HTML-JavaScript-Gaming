...
# sample 0319 - Hitboxes vs Hurtboxes

Sample-local contract for `old_samples/phase-03/0319`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0319/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0319` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0319/assets/images`.
...
```text
old_samples/phase-03/0319/index.html
old_samples/phase-03/0319
0319
```
...
# Sample 067 - Hitboxes vs Hurtboxes

Move with WASD or Arrow Keys.
Press Space to create an attack hitbox.
The enemy body is gray.
The enemy hurtbox is red.
The player body collision is separate from attack overlap.
