...
# sample 0307 - Slopes / Ramps

Sample-local contract for `old_samples/phase-03/0307`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0307/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0307` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0307/assets/images`.
...
```text
old_samples/phase-03/0307/index.html
old_samples/phase-03/0307
0307
```
...
# Sample 055 - Slopes / Ramps

## Purpose
Demonstrates a first-pass ramp floor model where the actor snaps to a computed floor height on purple ramps.

## Controls
A/D or Left/Right to move. Space to jump.

## Notes
This build uses a simple math-based ramp floor and does not yet include generalized polygon collision.
