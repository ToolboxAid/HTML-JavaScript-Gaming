...
Sample-local contract for `old_samples/phase-03/0325`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0325/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/GravityAudio.js`
- `game/GravityInputController.js`
- `game/GravityScene.js`
- `game/GravityWorld.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-03/0325` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0325/assets/images`.
...
```text
old_samples/phase-03/0325/index.html
old_samples/phase-03/0325
0325
```
