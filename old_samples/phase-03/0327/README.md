...
Sample-local contract for `old_samples/phase-03/0327`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0327/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/MultiBallChaosAudio.js`
- `game/MultiBallChaosInputController.js`
- `game/MultiBallChaosScene.js`
- `game/MultiBallChaosWorld.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-03/0327` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0327/assets/images`.
...
```text
old_samples/phase-03/0327/index.html
old_samples/phase-03/0327
0327
```
