...
# sample 0702 - Controller Support

Sample-local contract for `old_samples/phase-07/0702`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0702/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0702` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0702/assets/images`.
...
```text
old_samples/phase-07/0702/index.html
old_samples/phase-07/0702
0702
```
