...
# sample 0710 - Achievements System

Sample-local contract for `old_samples/phase-07/0710`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0710/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0710` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0710/assets/images`.
...
```text
old_samples/phase-07/0710/index.html
old_samples/phase-07/0710
0710
```
