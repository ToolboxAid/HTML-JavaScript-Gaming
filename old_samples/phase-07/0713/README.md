...
# sample 0713 - Fullscreen Ability

Sample-local contract for `old_samples/phase-07/0713`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0713/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0713` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0713/assets/images`.
...
```text
old_samples/phase-07/0713/index.html
old_samples/phase-07/0713
0713
```
