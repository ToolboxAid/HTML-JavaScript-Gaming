...
# sample 0705 - Asset Optimization

Sample-local contract for `old_samples/phase-07/0705`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0705/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0705` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0705/assets/images`.
...
```text
old_samples/phase-07/0705/index.html
old_samples/phase-07/0705
0705
```
