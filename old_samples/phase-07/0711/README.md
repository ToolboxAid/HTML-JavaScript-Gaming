...
# sample 0711 - Localization System

Sample-local contract for `old_samples/phase-07/0711`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0711/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0711` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0711/assets/images`.
...
```text
old_samples/phase-07/0711/index.html
old_samples/phase-07/0711
0711
```
