...
# sample 0706 - Memory Management

Sample-local contract for `old_samples/phase-07/0706`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0706/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0706` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0706/assets/images`.
...
```text
old_samples/phase-07/0706/index.html
old_samples/phase-07/0706
0706
```
