...
# sample 0709 - Mini-Map System

Sample-local contract for `old_samples/phase-07/0709`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0709/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0709` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0709/assets/images`.
...
```text
old_samples/phase-07/0709/index.html
old_samples/phase-07/0709
0709
```
