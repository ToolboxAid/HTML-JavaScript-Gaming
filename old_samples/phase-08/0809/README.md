...
Sample-local contract for `old_samples/phase-08/0809`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0809/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0809` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0809/assets/images`.
...
```text
old_samples/phase-08/0809/index.html
old_samples/phase-08/0809
0809
```
