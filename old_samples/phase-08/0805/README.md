...
Sample-local contract for `old_samples/phase-08/0805`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0805/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0805` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0805/assets/images`.
...
```text
old_samples/phase-08/0805/index.html
old_samples/phase-08/0805
0805
```
