...
Sample-local contract for `old_samples/phase-08/0803`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0803/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0803` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0803/assets/images`.
...
```text
old_samples/phase-08/0803/index.html
old_samples/phase-08/0803
0803
```
