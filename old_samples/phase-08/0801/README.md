...
Sample-local contract for `old_samples/phase-08/0801`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0801/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0801` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0801/assets/images`.
...
```text
old_samples/phase-08/0801/index.html
old_samples/phase-08/0801
0801
```
