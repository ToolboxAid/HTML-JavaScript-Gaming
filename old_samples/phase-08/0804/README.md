...
Sample-local contract for `old_samples/phase-08/0804`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0804/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0804` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0804/assets/images`.
...
```text
old_samples/phase-08/0804/index.html
old_samples/phase-08/0804
0804
```
