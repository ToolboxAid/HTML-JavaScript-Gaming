...
Sample-local contract for `old_samples/phase-08/0802`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0802/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0802` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0802/assets/images`.
...
```text
old_samples/phase-08/0802/index.html
old_samples/phase-08/0802
0802
```
