...
# sample 1001 - MP3 Player

Sample-local contract for `old_samples/phase-10/1001`.

## Implementation Location

- Entrypoint: `old_samples/phase-10/1001/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-10/1001` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-10/1001/assets/images`.
...
```text
old_samples/phase-10/1001/index.html
old_samples/phase-10/1001
1001
```
