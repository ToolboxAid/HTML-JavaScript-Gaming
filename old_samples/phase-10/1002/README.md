...
# sample 1002 - Cookie Write / Read System

Sample-local contract for `old_samples/phase-10/1002`.

## Implementation Location

- Entrypoint: `old_samples/phase-10/1002/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-10/1002` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-10/1002/assets/images`.
...
```text
old_samples/phase-10/1002/index.html
old_samples/phase-10/1002
1002
```
