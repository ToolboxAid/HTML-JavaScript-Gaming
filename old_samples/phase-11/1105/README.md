...
# sample 1105 - Crash Recovery / Fallback Flow

Sample-local contract for `old_samples/phase-11/1105`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1105/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1105` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1105/assets/images`.
...
```text
old_samples/phase-11/1105/index.html
old_samples/phase-11/1105
1105
```
