...
# sample 1101 - Settings System

Sample-local contract for `old_samples/phase-11/1101`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1101/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1101` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1101/assets/images`.
...
```text
old_samples/phase-11/1101/index.html
old_samples/phase-11/1101
1101
```
