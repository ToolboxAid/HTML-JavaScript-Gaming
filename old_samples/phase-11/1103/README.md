...
# sample 1103 - Deployment Profiles

Sample-local contract for `old_samples/phase-11/1103`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1103/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1103` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1103/assets/images`.
...
```text
old_samples/phase-11/1103/index.html
old_samples/phase-11/1103
1103
```
