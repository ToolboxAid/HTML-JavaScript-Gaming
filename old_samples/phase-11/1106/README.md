...
# sample 1106 - Release Validation Checklist Flow

Sample-local contract for `old_samples/phase-11/1106`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1106/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1106` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-11` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1106/assets/images`.
...
```text
old_samples/phase-11/1106/index.html
old_samples/phase-11/1106
1106
```
