...
Sample-local contract for `old_samples/phase-16/1617`.

## Implementation Location

- Entrypoint: `old_samples/phase-16/1617/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-16/1617` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-16/1617/assets/images`.
...
```text
old_samples/phase-16/1617/index.html
old_samples/phase-16/1617
1617
```
