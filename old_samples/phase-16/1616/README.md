...
Sample-local contract for `old_samples/phase-16/1616`.

## Implementation Location

- Entrypoint: `old_samples/phase-16/1616/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-16/1616` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-16/1616/assets/images`.
...
```text
old_samples/phase-16/1616/index.html
old_samples/phase-16/1616
1616
```
