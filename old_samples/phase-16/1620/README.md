...
Sample-local contract for `old_samples/phase-16/1620`.

## Implementation Location

- Entrypoint: `old_samples/phase-16/1620/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-16/1620` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-16/1620/assets/images`.
...
```text
old_samples/phase-16/1620/index.html
old_samples/phase-16/1620
1620
```
