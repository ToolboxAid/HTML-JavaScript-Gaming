...
Sample-local contract for `old_samples/phase-16/1618`.

## Implementation Location

- Entrypoint: `old_samples/phase-16/1618/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-16/1618` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-16/1618/assets/images`.
...
```text
old_samples/phase-16/1618/index.html
old_samples/phase-16/1618
1618
```
