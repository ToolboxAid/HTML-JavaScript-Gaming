...
# Sample 1303 - Asteroids World Systems

Sample-local contract for `old_samples/phase-13/1303`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1303/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1303` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1303/assets/images`.
...
```text
old_samples/phase-13/1303/index.html
old_samples/phase-13/1303
1303
```
