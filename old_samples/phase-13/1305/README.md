...
# Sample 1305 - Serialization System

Sample-local contract for `old_samples/phase-13/1305`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1305/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1305` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1305/assets/images`.
...
```text
old_samples/phase-13/1305/index.html
old_samples/phase-13/1305
1305
```
