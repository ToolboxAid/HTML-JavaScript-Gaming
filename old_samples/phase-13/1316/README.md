...
# Sample 1316 - Local Loopback / Fake Network

Sample-local contract for `old_samples/phase-13/1316`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1316/index.html`
...
- `debug/networkSampleADebug.js`
- `game/FakeLoopbackNetworkModel.js`
- `game/NetworkSampleAScene.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-13/1316` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1316/assets/images`.
...
```text
old_samples/phase-13/1316/index.html
old_samples/phase-13/1316
1316
```
