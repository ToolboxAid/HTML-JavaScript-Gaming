...
# Sample 1311 - Interest Management

Sample-local contract for `old_samples/phase-13/1311`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1311/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1311` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1311/assets/images`.
...
```text
old_samples/phase-13/1311/index.html
old_samples/phase-13/1311
1311
```
