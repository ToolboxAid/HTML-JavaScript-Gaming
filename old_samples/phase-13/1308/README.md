...
# Sample 1308 - Lobby / Session System

Sample-local contract for `old_samples/phase-13/1308`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1308/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1308` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1308/assets/images`.
...
```text
old_samples/phase-13/1308/index.html
old_samples/phase-13/1308
1308
```
