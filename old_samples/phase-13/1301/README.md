...
# Sample 1301 - Networking Layer

Sample-local contract for `old_samples/phase-13/1301`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1301/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1301` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1301/assets/images`.
...
```text
old_samples/phase-13/1301/index.html
old_samples/phase-13/1301
1301
```
