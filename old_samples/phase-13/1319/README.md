...
# Sample 1319 - Real Network + Live Dashboard

Sample-local contract for `old_samples/phase-13/1319`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1319/index.html`
...
- `game/RealNetworkLaunchScene.js`
- `index.html`
- `main.js`
- `networkSample1319.css`
- `server/realNetworkDashboard.mjs`
- `server/realNetworkServer.mjs`

## Discovery Contract

- This sample is valid because the physical folder `old_samples/phase-13/1319` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1319/assets/images`.
- Asset folder status: missing.
...
```text
old_samples/phase-13/1319/index.html
old_samples/phase-13/1319
1319
```
