...
Sample-local contract for `old_samples/phase-01/0116`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0116/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0116` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0116/assets/images`.
...
```text
old_samples/phase-01/0116/index.html
old_samples/phase-01/0116
0116
```
...
## Behavior
Two entities move horizontally and bounce inside the play area using the same movement rules.
