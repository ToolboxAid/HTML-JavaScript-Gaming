...
Sample-local contract for `old_samples/phase-01/0114`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0114/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0114` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0114/assets/images`.
...
```text
old_samples/phase-01/0114/index.html
old_samples/phase-01/0114
0114
```
...
## What it shows
- nearest candidate blocker highlighting
- active overlap highlighting
- live collision status text
- reusable debug-friendly obstacle layout
- themed rendering for diagnostics

## Controls
- Arrow keys: move player

## Behavior
Yellow shows the nearest blocker to the player. Red shows a blocker that is actively overlapping the player.
