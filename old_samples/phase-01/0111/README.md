...
Sample-local contract for `old_samples/phase-01/0111`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0111/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0111` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0111/assets/images`.
...
```text
old_samples/phase-01/0111/index.html
old_samples/phase-01/0111
0111
```
...
## What it shows
- one moving player
- multiple solid rectangles
- per-frame collision scanning
- active blocking solid highlight
- themed renderer debug output

## Controls
- Arrow keys: move player

## Behavior
When the player overlaps any solid, movement is reverted and the blocking solid is highlighted.
