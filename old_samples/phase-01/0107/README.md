...
# Sample 0107 - Entity Movement

Sample-local contract for `old_samples/phase-01/0107`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0107/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0107` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0107/assets/images`.
...
```text
old_samples/phase-01/0107/index.html
old_samples/phase-01/0107
0107
```
