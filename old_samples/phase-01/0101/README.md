...
# Sample 0101 - Basic Loop

Sample-local contract for `old_samples/phase-01/0101`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0101/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0101` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0101/assets/images`.
...
```text
old_samples/phase-01/0101/index.html
old_samples/phase-01/0101
0101
```
