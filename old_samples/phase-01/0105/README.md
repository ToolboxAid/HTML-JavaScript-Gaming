...
# Sample 0105 - Scene Switch

Sample-local contract for `old_samples/phase-01/0105`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0105/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0105` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0105/assets/images`.
...
```text
old_samples/phase-01/0105/index.html
old_samples/phase-01/0105
0105
```
