...
Sample-local contract for `old_samples/phase-01/0115`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0115/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0115` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0115/assets/images`.
...
```text
old_samples/phase-01/0115/index.html
old_samples/phase-01/0115
0115
```
...
- component maps
- component lookup
- rendering from queried components
- minimal ECS layout

## Behavior
The sample creates a player entity and a wall entity, then renders both through shared component access.
