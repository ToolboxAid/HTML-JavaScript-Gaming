...
Sample-local contract for `old_samples/phase-01/0109`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0109/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0109` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0109/assets/images`.
...
```text
old_samples/phase-01/0109/index.html
old_samples/phase-01/0109
0109
```
...
- overlap detection
- renderer-based debug visualization
- themed rendering consistency

## Controls
- Arrow keys: move player

## Behavior
The player box turns red when overlapping the static block.

## Notes
This is the foundation layer for future collision response systems.
