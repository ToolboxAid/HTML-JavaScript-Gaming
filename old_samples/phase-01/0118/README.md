...
Sample-local contract for `old_samples/phase-01/0118`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0118/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0118` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0118/assets/images`.
...
```text
old_samples/phase-01/0118/index.html
old_samples/phase-01/0118
0118
```
...
## What it shows
- ECS-controlled player
- solid entities
- shared collision test
- movement blocking
...
## Behavior
The player entity is blocked when it attempts to move into any solid entity.
