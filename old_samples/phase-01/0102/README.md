...
# Sample 0102 - Keyboard Move

Sample-local contract for `old_samples/phase-01/0102`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0102/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0102` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0102/assets/images`.
...
```text
old_samples/phase-01/0102/index.html
old_samples/phase-01/0102
0102
```
