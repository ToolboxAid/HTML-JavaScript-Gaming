...
# sample 0504 - Knockback Response

Sample-local contract for `old_samples/phase-05/0504`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0504/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0504` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0504/assets/images`.
...
```text
old_samples/phase-05/0504/index.html
old_samples/phase-05/0504
0504
```
