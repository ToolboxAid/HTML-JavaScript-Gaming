...
# sample 0502 - Attack Timing Windows

Sample-local contract for `old_samples/phase-05/0502`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0502/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0502` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0502/assets/images`.
...
```text
old_samples/phase-05/0502/index.html
old_samples/phase-05/0502
0502
```
