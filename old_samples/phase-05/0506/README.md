...
# sample 0506 - Combat Debug Overlay

Sample-local contract for `old_samples/phase-05/0506`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0506/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0506` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0506/assets/images`.
...
```text
old_samples/phase-05/0506/index.html
old_samples/phase-05/0506
0506
```
