...
# sample 0508 - State Machine Framework

Sample-local contract for `old_samples/phase-05/0508`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0508/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0508` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0508/assets/images`.
...
```text
old_samples/phase-05/0508/index.html
old_samples/phase-05/0508
0508
```
