...
# sample 0510 - Asset Loader System

Sample-local contract for `old_samples/phase-05/0510`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0510/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0510` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0510/assets/images`.
...
```text
old_samples/phase-05/0510/index.html
old_samples/phase-05/0510
0510
```
