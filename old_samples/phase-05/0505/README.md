...
# sample 0505 - Health + Death State

Sample-local contract for `old_samples/phase-05/0505`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0505/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0505` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0505/assets/images`.
...
```text
old_samples/phase-05/0505/index.html
old_samples/phase-05/0505
0505
```
