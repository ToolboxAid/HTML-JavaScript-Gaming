...
# sample 0507 - Event Bus

Sample-local contract for `old_samples/phase-05/0507`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0507/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0507` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0507/assets/images`.
...
```text
old_samples/phase-05/0507/index.html
old_samples/phase-05/0507
0507
```
