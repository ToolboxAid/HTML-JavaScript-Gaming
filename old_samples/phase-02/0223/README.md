...
Sample-local contract for `old_samples/phase-02/0223`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0223/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0223` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0223/assets/images`.
...
```text
old_samples/phase-02/0223/index.html
old_samples/phase-02/0223
0223
```
...
- JSON-based persistence shape
- reusable save/load boundary
- world-state transfer format
...
## Behavior
The scene can save and restore a JSON snapshot of the current world state.
