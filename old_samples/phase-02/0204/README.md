...
Sample-local contract for `old_samples/phase-02/0204`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0204/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0204` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0204/assets/images`.
...
```text
old_samples/phase-02/0204/index.html
old_samples/phase-02/0204
0204
```
...
## What it shows
- asset registry object
- centralized asset definitions
- image/audio/data grouping
- scene access to registered assets
- loader-ready structure

## Behavior
The sample displays asset definitions that are registered in one shared place rather than scattered through scene code.
