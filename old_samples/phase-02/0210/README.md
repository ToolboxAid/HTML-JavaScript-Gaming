...
Sample-local contract for `old_samples/phase-02/0210`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0210/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0210` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0210/assets/images`.
...
```text
old_samples/phase-02/0210/index.html
old_samples/phase-02/0210
0210
```
...
- projectile motion
- projectile lifetime
- shared projectile helpers
- gameplay-oriented entity bursts
...
## Behavior
The actor can spawn projectiles that move across the play area and expire automatically.
