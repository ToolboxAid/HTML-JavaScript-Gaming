...
Sample-local contract for `old_samples/phase-02/0211`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0211/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0211` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0211/assets/images`.
...
```text
old_samples/phase-02/0211/index.html
old_samples/phase-02/0211
0211
```
...
## What it shows
- patrol movement
- patrol direction swap
- player detection range
- engine AI helpers
- enemy state feedback

## Controls
- Arrow keys: move player

## Behavior
The enemy patrols between two points and highlights when the player enters its detection range.
