...
# Sample 0212 - Playable Micro-Level

Sample-local contract for `old_samples/phase-02/0212`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0212/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0212` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0212/assets/images`.
...
```text
old_samples/phase-02/0212/index.html
old_samples/phase-02/0212
0212
```
...
## Behavior
Flip the switch to unlock the goal, avoid or disable the enemy, and reach the goal to win.
