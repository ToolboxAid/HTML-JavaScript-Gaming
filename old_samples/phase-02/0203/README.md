...
Sample-local contract for `old_samples/phase-02/0203`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0203/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0203` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0203/assets/images`.
...
```text
old_samples/phase-02/0203/index.html
old_samples/phase-02/0203
0203
```
...
## Behavior
The minimap shows where the player is in the world and what portion of the world is currently visible on screen.
