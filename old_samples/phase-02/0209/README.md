...
Sample-local contract for `old_samples/phase-02/0209`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0209/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0209` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0209/assets/images`.
...
```text
old_samples/phase-02/0209/index.html
old_samples/phase-02/0209
0209
```
...
## Behavior
The actor can toggle nearby interactable objects using the interaction system.
