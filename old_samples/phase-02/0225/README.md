...
Sample-local contract for `old_samples/phase-02/0225`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0225/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/ProjectileLabModel.js`
- `game/ProjectileLabScene.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-02/0225` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0225/assets/images`.
...
```text
old_samples/phase-02/0225/index.html
old_samples/phase-02/0225
0225
```
