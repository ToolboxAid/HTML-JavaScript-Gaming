...
# Sample 0220 - Camera System

Sample-local contract for `old_samples/phase-02/0220`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0220/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0220` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0220/assets/images`.
...
```text
old_samples/phase-02/0220/index.html
old_samples/phase-02/0220
0220
```
...
## What it shows
- shared camera follow
- world-to-screen conversion
- clamped camera
- no scene-local offset math
- larger world rendering

## Controls
- Arrow keys: move actor

## Behavior
The camera follows the actor while world objects render through shared camera helpers.
