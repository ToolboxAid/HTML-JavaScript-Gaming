...
Sample-local contract for `old_samples/phase-02/0208`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0208/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0208` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0208/assets/images`.
...
```text
old_samples/phase-02/0208/index.html
old_samples/phase-02/0208
0208
```
...
- blocked state
- state transitions
- engine-owned state logic

## Controls
- Arrow keys: move actor

## Behavior
The actor changes state based on movement and collision conditions.
