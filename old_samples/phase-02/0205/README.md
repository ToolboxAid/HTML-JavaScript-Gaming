...
Sample-local contract for `old_samples/phase-02/0205`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0205/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0205` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0205/assets/images`.
...
```text
old_samples/phase-02/0205/index.html
old_samples/phase-02/0205
0205
```
...
## Behavior
The player's position can be saved and restored through browser storage.
