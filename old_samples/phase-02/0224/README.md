...
Sample-local contract for `old_samples/phase-02/0224`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0224/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0224` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0224/assets/images`.
...
```text
old_samples/phase-02/0224/index.html
old_samples/phase-02/0224
0224
```
...
- sprite-atlas-style frame lookup
- world serialization
- integrated playable slice
