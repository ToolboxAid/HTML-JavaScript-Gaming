...
Sample-local contract for `old_samples/phase-02/0218`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0218/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0218` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0218/assets/images`.
...
```text
old_samples/phase-02/0218/index.html
old_samples/phase-02/0218
0218
```
...
## Behavior
Unlock the goal, avoid or disable the enemy, and reach the goal to win.
