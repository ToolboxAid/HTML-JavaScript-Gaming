...
Sample-local contract for `old_samples/phase-19/1901`.

## Implementation Location

- Entrypoint: `old_samples/phase-19/1901/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-19/1901` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-19/1901/assets/images`.
...
```text
old_samples/phase-19/1901/index.html
old_samples/phase-19/1901
1901
```
