...
Sample-local contract for `old_samples/phase-04/0405`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0405/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0405` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0405/assets/images`.
...
```text
old_samples/phase-04/0405/index.html
old_samples/phase-04/0405
0405
```
