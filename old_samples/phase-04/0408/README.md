...
Sample-local contract for `old_samples/phase-04/0408`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0408/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0408` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0408/assets/images`.
...
```text
old_samples/phase-04/0408/index.html
old_samples/phase-04/0408
0408
```
...
## Notes
Press `J`, `K`, or `L` while the gate is locked.
When the gate opens, the highest priority queued action executes.
