...
Sample-local contract for `old_samples/phase-04/0409`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0409/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0409` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0409/assets/images`.
...
```text
old_samples/phase-04/0409/index.html
old_samples/phase-04/0409
0409
```
...
## Notes
Press `Space` while the pulse is inside the gold zone.
The action only counts when the timing window is open.
