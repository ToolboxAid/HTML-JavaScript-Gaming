...
Sample-local contract for `old_samples/phase-04/0407`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0407/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0407` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0407/assets/images`.
...
```text
old_samples/phase-04/0407/index.html
old_samples/phase-04/0407
0407
```
...
## Notes
Press `Space` just before the actor lands.
The jump is buffered in the input service and consumed on landing.
