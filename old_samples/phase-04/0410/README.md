...
Sample-local contract for `old_samples/phase-04/0410`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0410/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0410` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0410/assets/images`.
...
```text
old_samples/phase-04/0410/index.html
old_samples/phase-04/0410
0410
```
...
## Notes
Press `Space` to cast.
Repeated presses during cooldown are blocked until the timer expires.
