...
Sample-local contract for `old_samples/phase-04/0401`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0401/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0401` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0401/assets/images`.
...
```text
old_samples/phase-04/0401/index.html
old_samples/phase-04/0401
0401
```
