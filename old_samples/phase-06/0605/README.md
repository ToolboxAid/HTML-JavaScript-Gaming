...
Sample-local contract for `old_samples/phase-06/0605`.

## Implementation Location

- Entrypoint: `old_samples/phase-06/0605/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-06/0605` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-06/0605/assets/images`.
...
```text
old_samples/phase-06/0605/index.html
old_samples/phase-06/0605
0605
```
