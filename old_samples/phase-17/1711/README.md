...
# Sample 1711 - Movement Models Lab

Sample-local contract for `old_samples/phase-17/1711`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1711/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1711` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1711/assets/images`.
...
```text
old_samples/phase-17/1711/index.html
old_samples/phase-17/1711
1711
```
