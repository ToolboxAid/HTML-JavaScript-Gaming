...
Sample-local contract for `old_samples/phase-17/1713`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1713/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1713` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1713/assets/images`.
...
```text
old_samples/phase-17/1713/index.html
old_samples/phase-17/1713
1713
```
