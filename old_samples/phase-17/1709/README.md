...
Sample-local contract for `old_samples/phase-17/1709`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1709/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1709` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1709/assets/images`.
...
```text
old_samples/phase-17/1709/index.html
old_samples/phase-17/1709
1709
```
