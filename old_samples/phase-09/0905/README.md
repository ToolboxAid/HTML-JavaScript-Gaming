...
# sample 0905 - Pixel-Perfect Collision

Sample-local contract for `old_samples/phase-09/0905`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0905/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0905` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0905/assets/images`.
...
```text
old_samples/phase-09/0905/index.html
old_samples/phase-09/0905
0905
```
