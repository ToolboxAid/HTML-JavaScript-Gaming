...
Sample-local contract for `old_samples/phase-09/0903`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0903/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0903` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0903/assets/images`.
...
```text
old_samples/phase-09/0903/index.html
old_samples/phase-09/0903
0903
```
