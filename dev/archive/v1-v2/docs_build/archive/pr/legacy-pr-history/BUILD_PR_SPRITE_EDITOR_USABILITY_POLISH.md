...
## Goal
Implement approved usability improvements for the isolated Sprite Editor at `toolbox/Sprite Editor/` without expanding scope.
...
- docs_build/reports for this BUILD bundle

Out of scope:
- engine changes
- unrelated tools
- legacy or pre-existing sprite editor implementations outside `toolbox/Sprite Editor/`
- sample/game edits
