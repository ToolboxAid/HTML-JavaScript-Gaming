...
## Goal
Normalize `docs_build/archive/dev-ops/BIG_PICTURE_ROADMAP.md` encoding so the file renders consistently across Windows tooling without changing roadmap content or bracket states.

## Workflow
PLAN_PR -> BUILD_PR -> APPLY_PR

## In Scope
- Encoding normalization for `docs_build/archive/dev-ops/BIG_PICTURE_ROADMAP.md`.
