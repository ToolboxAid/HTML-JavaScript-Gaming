...
## Scope
- Tile authoring sample under `toolbox/Tilemap Studio/samples/`
- Parallax authoring sample under `toolbox/Parallax Scene Studio/samples/`
...
## Deliverables
- `toolbox/Tilemap Studio/samples/mario_style_learning_level_tilemap.json`
- `toolbox/Parallax Scene Studio/samples/mario_style_learning_level_parallax.json`
- Manifest updates in both sample directories so fallback manifest-based loading includes the Mario sample.
- Dev reports in `docs_build/dev/reports/`.
