...
- `docs_build/dev/NETWORK_SAMPLES_PLAN.md` staged execution model.
- Bracket-only updates to `docs_build/archive/dev-ops/BIG_PICTURE_ROADMAP.md` Track G state markers.
