...
```text
Get-Content docs_build/dev/PROJECT_INSTRUCTIONS.md -ErrorAction SilentlyContinue
Get-Content .codex/skills/repo-build/SKILL.md
Get-Content docs_build/dev/reports/PR_26151_007-gamefoundry-ssot-cleanup-validation.md -ErrorAction SilentlyContinue
git status --short
