...
Sample-local contract for `old_samples/phase-16/1603`.

## Implementation Location

- Entrypoint: `old_samples/phase-16/1603/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-16/1603` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-16/1603/assets/images`.
...
```text
old_samples/phase-16/1603/index.html
old_samples/phase-16/1603
1603
```
