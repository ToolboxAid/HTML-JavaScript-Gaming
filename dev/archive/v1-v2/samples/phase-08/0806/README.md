...
Sample-local contract for `old_samples/phase-08/0806`.

## Implementation Location

- Entrypoint: `old_samples/phase-08/0806/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-08/0806` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-08/0806/assets/images`.
...
```text
old_samples/phase-08/0806/index.html
old_samples/phase-08/0806
0806
```
