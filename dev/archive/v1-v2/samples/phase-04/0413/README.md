...
Sample-local contract for `old_samples/phase-04/0413`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0413/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/ThrusterAudio.js`
- `game/ThrusterInputController.js`
- `game/ThrusterScene.js`
- `game/ThrusterWorld.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-04/0413` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0413/assets/images`.
...
```text
old_samples/phase-04/0413/index.html
old_samples/phase-04/0413
0413
```
