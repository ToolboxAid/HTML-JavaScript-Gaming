...
# Sample 1712 - Gameplay Metrics & Telemetry

Sample-local contract for `old_samples/phase-17/1712`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1712/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1712` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-17` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1712/assets/images`.
...
```text
old_samples/phase-17/1712/index.html
old_samples/phase-17/1712
1712
```
