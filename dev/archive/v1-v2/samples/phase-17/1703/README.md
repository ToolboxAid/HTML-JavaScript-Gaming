...
Sample-local contract for `old_samples/phase-17/1703`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1703/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1703` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1703/assets/images`.
...
```text
old_samples/phase-17/1703/index.html
old_samples/phase-17/1703
1703
```
