...
# Sample 1710 - Real Gameplay Mini-Game

Sample-local contract for `old_samples/phase-17/1710`.

## Implementation Location

- Entrypoint: `old_samples/phase-17/1710/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-17/1710` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-17/1710/assets/images`.
...
```text
old_samples/phase-17/1710/index.html
old_samples/phase-17/1710
1710
```
