...
# Sample 1210 - Tilemap Objective Layout Preset

Sample-local contract for `old_samples/phase-12/1210`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1210/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1210` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1210/assets/images`.
...
```text
old_samples/phase-12/1210/index.html
old_samples/phase-12/1210
1210
```
