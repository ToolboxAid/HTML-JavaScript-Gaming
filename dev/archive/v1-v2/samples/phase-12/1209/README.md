...
# Sample 1209 - Tilemap Basic Layout Preset

Sample-local contract for `old_samples/phase-12/1209`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1209/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1209` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1209/assets/images`.
...
```text
old_samples/phase-12/1209/index.html
old_samples/phase-12/1209
1209
```
