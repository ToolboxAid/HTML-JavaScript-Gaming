...
# Sample 1217 - Vector Asset Mario Backdrop Preset

Sample-local contract for `old_samples/phase-12/1217`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1217/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1217` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1217/assets/images`.
...
```text
old_samples/phase-12/1217/index.html
old_samples/phase-12/1217
1217
```
