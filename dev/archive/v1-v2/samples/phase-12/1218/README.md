...
# Sample 1218 - Parallax Layered World Preset

Sample-local contract for `old_samples/phase-12/1218`.

## Implementation Location

- Entrypoint: `old_samples/phase-12/1218/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-12/1218` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-12/1218/assets/images`.
...
```text
old_samples/phase-12/1218/index.html
old_samples/phase-12/1218
1218
```
