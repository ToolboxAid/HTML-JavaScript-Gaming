...
# sample 0906 - Hybrid Collision (Bounds -> Shape -> Pixel)

Sample-local contract for `old_samples/phase-09/0906`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0906/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0906` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-09` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0906/assets/images`.
...
```text
old_samples/phase-09/0906/index.html
old_samples/phase-09/0906
0906
```
