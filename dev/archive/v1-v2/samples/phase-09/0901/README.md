...
# sample 0901 - Vector Rendering System

Sample-local contract for `old_samples/phase-09/0901`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0901/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0901` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0901/assets/images`.
...
```text
old_samples/phase-09/0901/index.html
old_samples/phase-09/0901
0901
```
