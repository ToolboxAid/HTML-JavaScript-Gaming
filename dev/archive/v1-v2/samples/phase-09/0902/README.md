...
# sample 0902 - Polygon Collision

Sample-local contract for `old_samples/phase-09/0902`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0902/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0902` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0902/assets/images`.
...
```text
old_samples/phase-09/0902/index.html
old_samples/phase-09/0902
0902
```
