...
Sample-local contract for `old_samples/phase-14/1404`.

## Implementation Location

- Entrypoint: `old_samples/phase-14/1404/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-14/1404` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-14/1404/assets/images`.
...
```text
old_samples/phase-14/1404/index.html
old_samples/phase-14/1404
1404
```
