...
Sample-local contract for `old_samples/phase-14/1405`.

## Implementation Location

- Entrypoint: `old_samples/phase-14/1405/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-14/1405` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-14/1405/assets/images`.
...
```text
old_samples/phase-14/1405/index.html
old_samples/phase-14/1405
1405
```
