...
Sample-local contract for `old_samples/phase-14/1407`.

## Implementation Location

- Entrypoint: `old_samples/phase-14/1407/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-14/1407` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-14/1407/assets/images`.
...
```text
old_samples/phase-14/1407/index.html
old_samples/phase-14/1407
1407
```
