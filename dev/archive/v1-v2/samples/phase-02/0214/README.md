...
# Sample 0214 - Animation Sprite Binding

Sample-local contract for `old_samples/phase-02/0214`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0214/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0214` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0214/assets/images`.
...
```text
old_samples/phase-02/0214/index.html
old_samples/phase-02/0214
0214
```
...
- sprite-ready frame ids
- render path connection
- clean animation/render boundary

## Controls
- Arrow keys: move actor

## Behavior
Animation state determines which frame-like render output is displayed.
