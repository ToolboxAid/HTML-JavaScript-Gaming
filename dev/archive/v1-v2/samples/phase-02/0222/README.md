...
Sample-local contract for `old_samples/phase-02/0222`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0222/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0222` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0222/assets/images`.
...
```text
old_samples/phase-02/0222/index.html
old_samples/phase-02/0222
0222
```
...
- engine-owned action input service

## Controls
- Arrow keys or WASD: move actor

## Behavior
The actor moves from named actions instead of direct key checks.
