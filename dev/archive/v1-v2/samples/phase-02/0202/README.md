...
Sample-local contract for `old_samples/phase-02/0202`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0202/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0202` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0202/assets/images`.
...
```text
old_samples/phase-02/0202/index.html
old_samples/phase-02/0202
0202
```
