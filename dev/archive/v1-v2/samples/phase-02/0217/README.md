...
Sample-local contract for `old_samples/phase-02/0217`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0217/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0217` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0217/assets/images`.
...
```text
old_samples/phase-02/0217/index.html
old_samples/phase-02/0217
0217
```
