...
Sample-local contract for `old_samples/phase-02/0201`.

## Implementation Location

- Entrypoint: `old_samples/phase-02/0201/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-02/0201` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-02/0201/assets/images`.
...
```text
old_samples/phase-02/0201/index.html
old_samples/phase-02/0201
0201
```
