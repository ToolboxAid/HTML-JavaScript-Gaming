...
# Sample 1902 - Workspace All Tools Integration

Sample-local contract for `old_samples/phase-19/1902`.

## Implementation Location

- Entrypoint: `old_samples/phase-19/1902/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-19/1902` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-19` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-19/1902/assets/images`.
...
```text
old_samples/phase-19/1902/index.html
old_samples/phase-19/1902
1902
```
