...
# sample 0501 - Hitboxes + Hurtboxes

Sample-local contract for `old_samples/phase-05/0501`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0501/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0501` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0501/assets/images`.
...
```text
old_samples/phase-05/0501/index.html
old_samples/phase-05/0501
0501
```
