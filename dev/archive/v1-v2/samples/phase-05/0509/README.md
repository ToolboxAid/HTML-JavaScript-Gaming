...
# sample 0509 - Config System

Sample-local contract for `old_samples/phase-05/0509`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0509/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0509` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0509/assets/images`.
...
```text
old_samples/phase-05/0509/index.html
old_samples/phase-05/0509
0509
```
