...
# sample 0511 - Debug Tools

Sample-local contract for `old_samples/phase-05/0511`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0511/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0511` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0511/assets/images`.
...
```text
old_samples/phase-05/0511/index.html
old_samples/phase-05/0511
0511
```
