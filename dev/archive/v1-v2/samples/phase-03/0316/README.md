...
# sample 0316 - Doors Gates

Sample-local contract for `old_samples/phase-03/0316`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0316/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0316` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0316/assets/images`.
...
```text
old_samples/phase-03/0316/index.html
old_samples/phase-03/0316
0316
```
...
# Sample 064 - Doors / Gates

Shows a button opening a gate by changing whether the gate is part of the solid set.
