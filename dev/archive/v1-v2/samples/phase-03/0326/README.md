...
Sample-local contract for `old_samples/phase-03/0326`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0326/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/PaddleInterceptAudio.js`
- `game/PaddleInterceptInputController.js`
- `game/PaddleInterceptScene.js`
- `game/PaddleInterceptWorld.js`
- `index.html`
- `main.js`
...
- This sample is valid because the physical folder `old_samples/phase-03/0326` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0326/assets/images`.
...
```text
old_samples/phase-03/0326/index.html
old_samples/phase-03/0326
0326
```
