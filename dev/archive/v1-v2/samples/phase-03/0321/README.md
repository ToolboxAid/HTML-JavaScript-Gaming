...
# sample 0321 - Health System

Sample-local contract for `old_samples/phase-03/0321`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0321/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0321` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0321/assets/images`.
...
```text
old_samples/phase-03/0321/index.html
old_samples/phase-03/0321
0321
```
...
# Sample 069 - Health System

Move with WASD or Arrow Keys.
Press Space to damage the enemy when in range.
Press F to damage the player.
