...
# sample 0318 - Interaction Press Key

Sample-local contract for `old_samples/phase-03/0318`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0318/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0318` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0318/assets/images`.
...
```text
old_samples/phase-03/0318/index.html
old_samples/phase-03/0318
0318
```
...
# Sample 066 - Interaction Press Key

Demonstrates the generic interaction loop:
- detect interactable range
- show prompt
- press E to trigger behavior
