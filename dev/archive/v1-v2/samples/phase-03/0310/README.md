...
# sample 0310 - Moving Platforms

Sample-local contract for `old_samples/phase-03/0310`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0310/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0310` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0310/assets/images`.
...
```text
old_samples/phase-03/0310/index.html
old_samples/phase-03/0310
0310
```
...
# Sample 058 - Moving Platforms

## Purpose
Demonstrates moving platforms that carry the actor when standing on them.

## Controls
A/D to move, Space to jump.

## Notes
The carry behavior is a small first-pass implementation intended to keep the build surgical.
