...
# sample 0313 - Trigger Zones

Sample-local contract for `old_samples/phase-03/0313`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0313/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0313` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0313/assets/images`.
...
```text
old_samples/phase-03/0313/index.html
old_samples/phase-03/0313
0313
```
...
# Sample 061 - Trigger Zones

Shows enter and exit trigger events using overlap-only regions.
Walk and jump through the colored zones to see state transitions.
