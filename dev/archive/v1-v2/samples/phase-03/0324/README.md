...
# sample 0324 - Simple Enemy AI

Sample-local contract for `old_samples/phase-03/0324`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0324/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0324` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0324/assets/images`.
...
```text
old_samples/phase-03/0324/index.html
old_samples/phase-03/0324
0324
```
...
# Sample 072 - Simple Enemy AI

Move with WASD or Arrow Keys.
The enemy idles until you get close, then follows.
Touching the enemy reduces player HP on a cooldown.
Press R to reset.
