...
# Sample 1503 - Property Editor

Sample-local contract for `old_samples/phase-15/1503`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1503/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1503` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1503/assets/images`.
...
```text
old_samples/phase-15/1503/index.html
old_samples/phase-15/1503
1503
```
