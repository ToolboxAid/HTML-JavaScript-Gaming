...
# Sample 1504 - Live Tuning / Hot Reload

Sample-local contract for `old_samples/phase-15/1504`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1504/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1504` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1504/assets/images`.
...
```text
old_samples/phase-15/1504/index.html
old_samples/phase-15/1504
1504
```
