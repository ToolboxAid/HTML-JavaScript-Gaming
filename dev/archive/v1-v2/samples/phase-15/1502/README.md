...
# Sample 1502 - In-Engine Inspector

Sample-local contract for `old_samples/phase-15/1502`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1502/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1502` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1502/assets/images`.
...
```text
old_samples/phase-15/1502/index.html
old_samples/phase-15/1502
1502
```
