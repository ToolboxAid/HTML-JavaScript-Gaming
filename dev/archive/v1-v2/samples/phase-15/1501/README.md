...
# Sample 1501 - Developer Console

Sample-local contract for `old_samples/phase-15/1501`.

## Implementation Location

- Entrypoint: `old_samples/phase-15/1501/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-15/1501` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-15/1501/assets/images`.
...
```text
old_samples/phase-15/1501/index.html
old_samples/phase-15/1501
1501
```
