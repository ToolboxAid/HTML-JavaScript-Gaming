...
# sample 0712 - Packaging / Build System

Sample-local contract for `old_samples/phase-07/0712`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0712/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0712` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-07` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0712/assets/images`.
...
```text
old_samples/phase-07/0712/index.html
old_samples/phase-07/0712
0712
```
