...
# sample 0701 - Input Remapping

Sample-local contract for `old_samples/phase-07/0701`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0701/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0701` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0701/assets/images`.
...
```text
old_samples/phase-07/0701/index.html
old_samples/phase-07/0701
0701
```
