...
Sample-local contract for `old_samples/phase-01/0113`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0113/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0113` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0113/assets/images`.
...
```text
old_samples/phase-01/0113/index.html
old_samples/phase-01/0113
0113
```
...
## What it shows
- tile map as collision source
- solid and open tiles
- axis-separated movement response
- grid debug rendering
- transition toward map-driven gameplay

## Controls
- Arrow keys: move player

## Behavior
The player can move through open floor cells but is blocked by solid wall tiles.
