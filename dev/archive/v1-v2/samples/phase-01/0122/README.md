...
Sample-local contract for `old_samples/phase-01/0122`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0122/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0122` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0122/assets/images`.
...
```text
old_samples/phase-01/0122/index.html
old_samples/phase-01/0122
0122
```
...
## What it shows
- spawned pickup entities
- tags and lifetime data
- collection and expiration
- entity removal
...
## Behavior
Pickups spawn over time, can be collected by the player, and expire if they remain too long.
