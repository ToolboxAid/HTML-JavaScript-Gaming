...
Sample-local contract for `old_samples/phase-06/0607`.

## Implementation Location

- Entrypoint: `old_samples/phase-06/0607/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-06/0607` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-06/0607/assets/images`.
...
```text
old_samples/phase-06/0607/index.html
old_samples/phase-06/0607
0607
```
