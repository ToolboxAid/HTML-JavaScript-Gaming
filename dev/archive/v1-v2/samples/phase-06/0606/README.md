...
Sample-local contract for `old_samples/phase-06/0606`.

## Implementation Location

- Entrypoint: `old_samples/phase-06/0606/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-06/0606` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-06/0606/assets/images`.
...
```text
old_samples/phase-06/0606/index.html
old_samples/phase-06/0606
0606
```
