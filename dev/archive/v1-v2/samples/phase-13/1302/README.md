...
# Sample 1302 - State Sync / Replication

Sample-local contract for `old_samples/phase-13/1302`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1302/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1302` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1302/assets/images`.
...
```text
old_samples/phase-13/1302/index.html
old_samples/phase-13/1302
1302
```
