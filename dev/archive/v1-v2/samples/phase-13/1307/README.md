...
# Sample 1307 - Remote Entity Interpolation

Sample-local contract for `old_samples/phase-13/1307`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1307/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1307` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1307/assets/images`.
...
```text
old_samples/phase-13/1307/index.html
old_samples/phase-13/1307
1307
```
