...
# Sample 1306 - Network Debug Overlay

Sample-local contract for `old_samples/phase-13/1306`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1306/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1306` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1306/assets/images`.
...
```text
old_samples/phase-13/1306/index.html
old_samples/phase-13/1306
1306
```
