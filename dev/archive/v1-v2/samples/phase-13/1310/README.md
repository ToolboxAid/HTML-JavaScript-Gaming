...
# Sample 1310 - Host / Server Bootstrap

Sample-local contract for `old_samples/phase-13/1310`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1310/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-13/1310` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1310/assets/images`.
...
```text
old_samples/phase-13/1310/index.html
old_samples/phase-13/1310
1310
```
