...
Sample-local contract for `old_samples/phase-13/1320`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1320/index.html`
...
- `flow/highscore.js`
- `flow/intro.js`
- `game/PacmanLiteConfig.js`
- `game/PacmanLiteDebugOverlay.js`
- `game/PacmanLiteGhostController.js`
- `game/PacmanLiteGrid.js`
- `game/PacmanLiteInputController.js`
- `game/PacmanLiteNavigator.js`
- `game/PacmanLitePlayerController.js`
- `game/PacmanLiteScene.js`
- `game/PacmanLiteWorld.js`
- `index.html`
- `main.js`
- `rules/flowContent.js`
- `rules/flowRules.js`
- `rules/gameFlowRules.js`

## Discovery Contract

- This sample is valid because the physical folder `old_samples/phase-13/1320` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-13` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1320/assets/images`.
...
```text
old_samples/phase-13/1320/index.html
old_samples/phase-13/1320
1320
```
