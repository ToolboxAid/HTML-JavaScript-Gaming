...
# Sample 1317 - Host / Client Diagnostics

Sample-local contract for `old_samples/phase-13/1317`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1317/index.html`
...
- `debug/networkSampleBDebug.js`
- `game/FakeHostClientNetworkModel.js`
- `game/NetworkSampleBScene.js`
- `index.html`
- `main.js`

## Discovery Contract

- This sample is valid because the physical folder `old_samples/phase-13/1317` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1317/assets/images`.
...
```text
old_samples/phase-13/1317/index.html
old_samples/phase-13/1317
1317
```
