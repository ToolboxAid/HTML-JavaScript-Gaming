...
# sample 1003 - Audio Playlist / Track Management

Sample-local contract for `old_samples/phase-10/1003`.

## Implementation Location

- Entrypoint: `old_samples/phase-10/1003/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-10/1003` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-10` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-10/1003/assets/images`.
...
```text
old_samples/phase-10/1003/index.html
old_samples/phase-10/1003
1003
```
