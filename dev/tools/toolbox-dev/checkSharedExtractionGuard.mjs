...
const IGNORED_FILES = new Set(["dev/tools/toolbox-dev/checkSharedExtractionGuard.selftest.mjs"]);
// Backlog is tracked in a baseline so pretest can fail only on regressions.
const BASELINE_RELATIVE_PATH = "dev/tools/toolbox-dev/checkSharedExtractionGuard.baseline.json";
