...
## Coverage Guardrail
- Playwright generated the advisory V8 coverage report at `docs_build/dev/reports/coverage_changed_js_guardrail.txt`.
...
## Manual Validation
1. Review `docs_build/dev/reports/codex_review.diff` and confirm all shared index imports now point at canonical files.
