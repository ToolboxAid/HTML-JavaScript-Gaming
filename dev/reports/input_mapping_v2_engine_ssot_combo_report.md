...
## Coverage Report
- `docs_build/dev/reports/playwright_v8_coverage_report.txt` was regenerated by Playwright coverage hooks.
- `docs_build/dev/reports/coverage_changed_js_guardrail.txt` reports advisory coverage only.
