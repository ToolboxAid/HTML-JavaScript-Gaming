...
|---|---|---|---|
| `GameFoundryStudio/assets/partials/header-nav.html` | `retired Theme V2 tool template`, `dev/templates/page-template-v2.html` | Shared Theme V2 header and navigation chrome | Existing |
| `GameFoundryStudio/assets/partials/footer.html` | `retired Theme V2 tool template`, `dev/templates/page-template-v2.html` | Shared Theme V2 footer chrome | Existing |
| `GameFoundryStudio/assets/js/gamefoundry-partials.js` | `retired Theme V2 tool template`, `dev/templates/page-template-v2.html` | Existing shared partial loader for header/footer | Existing |
