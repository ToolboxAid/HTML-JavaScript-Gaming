...
- The only remaining `details`/`summary` markup in `toolbox/palette-manager-v2/index.html` is the shared platform shell wrapper above the app layout, outside `.palette-manager-v2__panel--left`.
