...
- `docs_build/dev/roadmaps/` -> `docs/roadmaps/` in active developer/tool docs.
...
- `docs_build/operations/dev/pr_naming_convention.md.md` -> `docs_build/operations/dev/pr_naming_convention.md` (superseded duplicate removed).
