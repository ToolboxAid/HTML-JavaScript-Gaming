...
- PASS: `node --check toolbox/text2speach-V2/js/controls/SpeechOptionsControl.js`
...
- `(100%) toolbox/text2speach-V2/js/bootstrap.js - changed JS file with browser V8 coverage`
- `(100%) toolbox/text2speach-V2/js/controls/ActionNavControl.js - changed JS file with browser V8 coverage`
- `(100%) toolbox/text2speach-V2/js/controls/SpeechOptionsControl.js - changed JS file with browser V8 coverage`
- `(100%) toolbox/text2speach-V2/js/TextToSpeechToolApp.js - changed JS file with browser V8 coverage`
