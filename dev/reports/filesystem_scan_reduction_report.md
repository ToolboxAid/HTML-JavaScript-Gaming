...
Generated: 2026-06-27T19:31:16.153Z
Status: PASS
...
| Path | Status | Reason |
| --- | --- | --- |
| dev/tests/playwright | BROAD | Standalone structural audit intentionally enumerated all Playwright ownership buckets. |
| dev/tests/helpers | BROAD | Standalone structural audit intentionally checked all shared helper ownership. |
