...
## Structure Notes
- `dev/tests/helpers/` holds shared test catalogs/helpers used by validation tests.
- `dev/tests/fixtures/` holds non-executable fixture artifacts (`.patch`, `.snippet`, and regex snapshots) kept out of executable suites.
