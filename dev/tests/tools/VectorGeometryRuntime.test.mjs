...
function createContractAsset() {
  return {
    ...
    type: "vector",
    path: "archive/v1-v2/games/vector-arcade-sample/assets/vectors/contract-sample.vector.json",
...
export async function run() {
  ...
  const legacyAsset = normalizeSvgToVectorAsset({
    ...
    name: "Legacy Sample",
    path: "archive/v1-v2/games/vector-arcade-sample/assets/vectors/legacy-sample.vector.json",
    paletteId: "palette.vector-native.primary",
  ...
  const invalidInspection = inspectVectorGeometryRuntimeAsset({
    ...
    source: { kind: "svg", path: "archive/v1-v2/games/vector-arcade-sample/assets/vectors/invalid.vector.json" },
