...
const DDL_FILES = Object.freeze([
  ...
  "dev/docs_build/database/ddl/admin.sql",
  "dev/docs_build/database/ddl/game-workspace.sql",
  "dev/docs_build/database/ddl/asset.sql",
  "dev/docs_build/database/ddl/objects.sql",
  "dev/docs_build/database/ddl/controls.sql",
  "dev/docs_build/database/ddl/game-design.sql",
  "dev/docs_build/database/ddl/game-configuration.sql",
  "dev/docs_build/database/ddl/game-journey.sql",
  "dev/docs_build/database/ddl/palette.sql",
  "dev/docs_build/database/ddl/tags.sql",
  "dev/docs_build/database/ddl/tool-metadata.sql",
  "dev/docs_build/database/ddl/tool-planning.sql",
  "dev/docs_build/database/ddl/toolbox-votes.sql",
  "dev/docs_build/database/ddl/support-tickets.sql",
]);
