...
- Do **not** change unrelated cleanup targets (`SpriteEditor_old_keep`, `legacy class-retention policy marker`, archived notes policy) in this PR.
...
- `docs_build/reports/templates_live_usage_inventory.md`
- `docs_build/reports/templates_policy_decision.md`
- `docs_build/reports/templates_validation_guard.md`
- `docs_build/reports/BUILD_PR_TEMPLATES_POLICY_CLASSIFICATION_report.md`
...
- `docs_build/reports/roadmap_status_delta.txt`

## Required Work

### 1) Live usage inventory for `templates/`
Create `docs_build/reports/templates_live_usage_inventory.md`.
...
Create `docs_build/reports/templates_policy_decision.md`.
...
Create `docs_build/reports/templates_validation_guard.md`.
...
### 5) BUILD report
Create `docs_build/reports/BUILD_PR_TEMPLATES_POLICY_CLASSIFICATION_report.md` with:
