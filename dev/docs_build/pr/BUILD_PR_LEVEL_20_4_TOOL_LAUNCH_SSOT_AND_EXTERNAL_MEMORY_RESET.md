...
- all sample tool launches go to `toolbox/<tool>/index.html`
- all game launches go to `toolbox/Workspace Manager/index.html`
...
Codex must read and follow `docs_build/dev/codex_rules.md` before editing.

## Required File Discovery
Inspect only the minimum files needed:
1. `samples/index.html`
2. `games/index.html`
3. `toolbox/Workspace Manager/index.html`
...
4. If no SSoT exists, create one small repo-consistent launch metadata file in the existing toolbox/index/navigation area.
