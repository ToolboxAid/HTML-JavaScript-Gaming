...
## Required outputs
- `docs_build/dev/reports/BUILD_PR_LEVEL_23_7_FULLSCREEN_RULE_ENFORCEMENT_AND_SAMPLE_0713_FIX_FULL_SCREEN_USAGE_AUDIT.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_23_7_FULLSCREEN_RULE_ENFORCEMENT_AND_SAMPLE_0713_FIX_UNAUTHORIZED_REMOVALS.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_23_7_FULLSCREEN_RULE_ENFORCEMENT_AND_SAMPLE_0713_FIX_SAMPLE_0713_FULLSCREEN_FIX.md`
- `docs_build/dev/reports/BUILD_PR_LEVEL_23_7_FULLSCREEN_RULE_ENFORCEMENT_AND_SAMPLE_0713_FIX_VALIDATION.md`
