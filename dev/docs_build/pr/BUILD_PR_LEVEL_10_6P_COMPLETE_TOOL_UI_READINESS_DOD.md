...
## Acceptance
- `docs_build/dev/dod/tool_ui_readiness_dod.md` exists and covers all current tool classes.
- `docs_build/dev/reports/level_10_6p_tool_ui_readiness_dod_gap_report.md` is created by Codex.
