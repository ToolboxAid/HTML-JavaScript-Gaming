...
## Scope Safety Checks
- `archive/v1-v2/docs_build/archive/tools/SpriteEditor_old_keep` modified: NO
...
- Vector helper normalization limited to existing string sanitization helper replacement in `toolbox/shared/vector/*`.
