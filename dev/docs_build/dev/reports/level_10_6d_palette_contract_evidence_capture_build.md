...
1. Create:
```text
docs_build/dev/reports/level_10_6d_palette_contract_evidence/
```
...
4. Create:
```text
docs_build/dev/reports/level_10_6d_palette_contract_evidence/palette_contract_evidence_report.md
```
