...
- Direct local read of `docs_build/dev/PROJECT_INSTRUCTIONS.md`: BLOCKED
- Blocker: `windows sandbox: spawn setup refresh`
- Authoritative fallback used: uploaded/chat-provided workflow instructions plus GitHub connector read of `docs_build/dev/PROJECT_INSTRUCTIONS.md` from `ToolboxAid/HTML-JavaScript-Gaming@main`.
