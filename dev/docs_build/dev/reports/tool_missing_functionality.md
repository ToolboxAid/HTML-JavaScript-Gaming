...
| 3D JSON Payload Normalizer | Deep workflow automation | Automated map load/edit/save contract checks. | Boot/load smoke only. | No automated map-document persistence checks. | Medium | Add deterministic map-document round-trip test lane. |
