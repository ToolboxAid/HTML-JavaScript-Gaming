...
- Tool mode launch: `toolbox/asset-manager-v2/index.html` loads with Asset Manager V2 title, tool nav visible, workspace nav hidden, and visible status/log output.
...
- Workspace mode launch: `toolbox/workspace-v2/index.html` launches Asset Manager V2 with `launch=workspace`, `fromTool=workspace-v2`, and `hostContextId`.
