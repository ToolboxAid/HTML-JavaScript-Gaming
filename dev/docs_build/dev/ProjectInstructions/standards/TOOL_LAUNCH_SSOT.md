...
- `samples/index.html`
- any sample page
- `dev/archive/v1-v2/games/index.html`
- any game page

External launches MUST clear launch memory before loading the target tool or workspace.

External launches MUST NOT reuse prior tool state, prior ProjectWorkspace state, stale selected tool values, stale selected game values, stale launch context, or prior session carryover.
