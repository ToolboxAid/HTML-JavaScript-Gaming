...
- `dev/docs_build/dev/ProjectInstructions/backlog/BACKLOG_MASTER.md` exists and is populated.
- `dev/docs_build/dev/ProjectInstructions/team_assignments/TEAM_ASSIGNMENTS.md` exists.
