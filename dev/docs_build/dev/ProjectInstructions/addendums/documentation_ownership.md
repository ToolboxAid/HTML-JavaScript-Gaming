...
`dev/docs_build/dev/reports/` owns:
- generated reports
...
- No generated report may exist outside `dev/docs_build/dev/reports/`.
...
- `dev/docs_build/dev/reports/audits/` contains audit report outputs.
...
- no generated reports outside `dev/docs_build/dev/reports/`
