...
Canonical environment/API model reference: `dev/docs_build/dev/ProjectInstructions/addendums/environment_governance_model.md`.
...
The canonical shared API/service contract rule lives in `dev/docs_build/dev/ProjectInstructions/addendums/environment_governance_model.md`.
