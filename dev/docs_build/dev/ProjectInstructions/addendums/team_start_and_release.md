...
Before implementation begins, ChatGPT/Codex must provide the SOD briefing defined in `dev/docs_build/dev/ProjectInstructions/addendums/team_backlog_sod_eod_standard.md`.
...
1. Read `dev/docs_build/dev/ProjectInstructions/backlog/BACKLOG_MASTER.md`.
...
- required reports and repo-structured ZIP under `dev/workspace/artifacts/tmp/` exist before Closed
...
- required repo-structured ZIP under `dev/workspace/artifacts/tmp/` exists
- backlog updated
- tool state updated when applicable

At EOD, ChatGPT/Codex must provide the team summary defined in `dev/docs_build/dev/ProjectInstructions/addendums/team_backlog_sod_eod_standard.md`.
