...
const SCAN_ROOTS = ["src", "dev/archive/v1-v2/samples", "toolbox"];
...
const IGNORED_FILES = new Set(["dev/docs_build/dev/toolbox/checkSharedExtractionGuard.selftest.mjs"]);
// Backlog is tracked in a baseline so pretest can fail only on regressions.
const BASELINE_RELATIVE_PATH = "dev/docs_build/dev/toolbox/checkSharedExtractionGuard.baseline.json";
