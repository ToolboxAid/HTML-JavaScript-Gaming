...
const passThroughScanRoots = ["src", "dev/archive/v1-v2/samples/shared", "toolbox"];
const importScanRoots = ["src", "dev/archive/v1-v2/samples", "toolbox", "tests"];
...
const baselineRelativePath = "dev/docs_build/dev/toolbox/checkInternalBarrelGuard.baseline.json";
