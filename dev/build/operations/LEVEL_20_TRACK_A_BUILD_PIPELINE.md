...
2. Deployment staging prep (apply mode)
   - `.\scripts\PS\deploy\Prep-WebsiteRepoDeployment.ps1 -StagingRoot <repo>\tmp\website-deploy-track20a -IncludePaths index.html,archive/v1-v2/games/index.html,samples/index.html,tools/index.html -Apply`
3. Deployment update + verification (apply mode)
   - `.\scripts\PS\deploy\Update-WebsiteRepoDeployment.ps1 -StagingRoot <repo>\tmp\website-deploy-track20a -IncludePaths index.html,archive/v1-v2/games/index.html,samples/index.html,tools/index.html -Apply -ConfirmDestructive`
