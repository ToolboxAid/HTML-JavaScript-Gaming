...
const IGNORED_FILES = new Set(["dev/build/dev/toolbox/checkSharedExtractionGuard.selftest.mjs"]);
// Backlog is tracked in a baseline so pretest can fail only on regressions.
const BASELINE_RELATIVE_PATH = "dev/build/dev/toolbox/checkSharedExtractionGuard.baseline.json";
