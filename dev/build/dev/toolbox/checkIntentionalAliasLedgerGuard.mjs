...
const ledgerPath = path.join(repoRoot, "dev/build/dev/toolbox/intentionalAliasLedger.json");
...
function run() {
  if (!fs.existsSync(ledgerPath)) {
    throw new Error("Missing dev/build/dev/toolbox/intentionalAliasLedger.json.");
  }
