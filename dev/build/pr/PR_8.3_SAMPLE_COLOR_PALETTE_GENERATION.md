...
- Keep shared schemas in `src/shared/schemas/`.

## Required Output Shape
Generated palette files must conform to:

`src/shared/schemas/palette.schema.json`
...
- Generated palettes validate against `src/shared/schemas/palette.schema.json`.
