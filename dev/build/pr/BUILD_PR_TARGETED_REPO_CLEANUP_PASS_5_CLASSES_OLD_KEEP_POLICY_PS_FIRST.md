...
Create `docs_build/dev/reports/legacy class-retention policy marker_policy_inventory.md`.
...
Create `docs_build/dev/reports/legacy class-retention policy marker_policy_decision.md`.
...
Create `docs_build/dev/reports/legacy class-retention policy marker_validation_guard.md`.
...
### 5) BUILD report
Create `docs_build/reports/BUILD_PR_TARGETED_REPO_CLEANUP_PASS_5_CLASSES_OLD_KEEP_POLICY_PS_FIRST_report.md` with:
