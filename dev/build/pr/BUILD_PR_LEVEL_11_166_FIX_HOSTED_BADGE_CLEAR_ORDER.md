...
5. SVG Asset Studio iframe initializes `src/shared/toolbox/platformShell.js`.
...
1. Update `src/shared/toolbox/platformShell.js` only unless a directly related validation doc/report is needed.
