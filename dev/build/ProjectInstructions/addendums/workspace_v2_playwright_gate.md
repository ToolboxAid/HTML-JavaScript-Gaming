...
## Output Paths
- Test artifacts are written under `dev/workspace/artifacts/tmp/test-results/`.
- Trace artifacts are written under `dev/workspace/artifacts/tmp/test-results/**` (for example in artifacts folders).
- HTML report is written under `dev/workspace/artifacts/tmp/test-results/report`.
