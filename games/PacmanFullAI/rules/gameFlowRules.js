...
export const PACMAN_FULL_AI_FLOW_LABELS = Object.freeze({
  attract: "Attract",
  intro: "Intro",
  highscore: "Highscore"
});
...
export const PACMAN_FULL_AI_GAME_OVER_RETURN_STATUS = "Press 1 for one player or 2 for two players.";
export const PACMAN_FULL_AI_GAME_OVER_RETURN_RESET_IDLE = true;

export const PACMAN_FULL_AI_HIGHSCORE_AUTO_EXIT_SECONDS = 12;
export const PACMAN_FULL_AI_HIGHSCORE_STATUS = "Pacman Full AI high scores";
