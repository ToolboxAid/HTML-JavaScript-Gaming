...
class ObjectKillable2 extends ObjectDynamic {
    ...
    update(deltaTime, incFrame = false) {
        switch (this.status) {
            case ObjectKillable2.Status.ALIVE: // Handle ALIVE status
                this.handleAliveStatus(deltaTime, incFrame);
                break;
            case ObjectKillable2.Status.DYING: // Handle DYING status
                this.handleDyingStatus();
                break;
            case ObjectKillable2.Status.OTHER: // Handle OTHER status
                this.handleOtherStatus();
                break;
            case ObjectKillable2.Status.DEAD: // Handle DEAD status
    ...
    isAlive() {
        return this.status === ObjectKillable2.Status.ALIVE;
    }

    isDying() {
        return this.status === ObjectKillable2.Status.DYING;
    }

    isOther() {
        return this.status === ObjectKillable2.Status.OTHER;
    }

    isDead() {
        return this.status === ObjectKillable2.Status.DEAD;
    }
    ...
    setIsDying() {
        this.status = ObjectKillable2.Status.DYING;
        this.currentFrameIndex = 0;
        this.delayCounter = 0;
    }

    setIsOther() {
        this.status = ObjectKillable2.Status.OTHER;
        this.currentFrameIndex = 0;
        this.delayCounter = 0;
    }

    setIsDead() {
        this.status = ObjectKillable2.Status.DEAD;
        this.currentFrameIndex = 0;
        this.delayCounter = 0;
    }
...
export default ObjectKillable2;