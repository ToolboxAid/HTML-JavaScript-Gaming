...
Sample-local contract for `old_samples/phase-14/1402`.

## Implementation Location

- Entrypoint: `old_samples/phase-14/1402/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-14/1402` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-14/1402/assets/images`.
...
```text
old_samples/phase-14/1402/index.html
old_samples/phase-14/1402
1402
```
