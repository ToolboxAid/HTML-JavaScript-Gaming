...
import { ThemeTokens } from '/src/engine/theme/ThemeTokens.js'; import RegressionPlaybackHarness from '/src/engine/automation/RegressionPlaybackHarness.js';
...
export default class RegressionPlaybackHarnessScene extends Scene {
  ...
  render(renderer) { drawFrame(renderer, theme, ['Engine Sample 1406', 'Regression playback turns prior scenarios into repeatable validation assets.', this.status]); renderer.drawRect(100, 250, 500, 80, '#0f172a'); renderer.drawRect(this.actorX, 275, 28, 28, '#34d399'); drawPanel(renderer, 640, 40, 220, 150, 'Playback', [`Frames: ${this.frames.length}`, `Index: ${this.index}`]); }
}
