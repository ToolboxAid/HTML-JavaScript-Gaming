...
Sample-local contract for `old_samples/phase-06/0604`.

## Implementation Location

- Entrypoint: `old_samples/phase-06/0604/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-06/0604` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-06/0604/assets/images`.
...
```text
old_samples/phase-06/0604/index.html
old_samples/phase-06/0604
0604
```
