...
Sample-local contract for `old_samples/phase-06/0612`.

## Implementation Location

- Entrypoint: `old_samples/phase-06/0612/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-06/0612` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-06/0612/assets/images`.
...
```text
old_samples/phase-06/0612/index.html
old_samples/phase-06/0612
0612
```
