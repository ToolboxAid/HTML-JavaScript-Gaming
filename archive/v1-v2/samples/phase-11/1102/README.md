...
# sample 1102 - Accessibility Options

Sample-local contract for `old_samples/phase-11/1102`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1102/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1102` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1102/assets/images`.
...
```text
old_samples/phase-11/1102/index.html
old_samples/phase-11/1102
1102
```
