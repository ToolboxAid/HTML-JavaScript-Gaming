...
# sample 1104 - Distribution Packaging

Sample-local contract for `old_samples/phase-11/1104`.

## Implementation Location

- Entrypoint: `old_samples/phase-11/1104/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-11/1104` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-11/1104/assets/images`.
...
```text
old_samples/phase-11/1104/index.html
old_samples/phase-11/1104
1104
```
