...
# Sample 1318 - Divergence / Trace Validation

Sample-local contract for `old_samples/phase-13/1318`.

## Implementation Location

- Entrypoint: `old_samples/phase-13/1318/index.html`
...
- `debug/networkSampleCDebug.js`
- `game/FakeDivergenceTraceNetworkModel.js`
- `game/NetworkSampleCScene.js`
- `game/ReconciliationLayerAdapter.js`
- `game/StateTimelineBuffer.js`
- `index.html`
- `main.js`

## Discovery Contract

- This sample is valid because the physical folder `old_samples/phase-13/1318` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-13/1318/assets/images`.
...
```text
old_samples/phase-13/1318/index.html
old_samples/phase-13/1318
1318
```
