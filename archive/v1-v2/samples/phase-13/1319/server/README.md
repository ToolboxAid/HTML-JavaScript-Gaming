...
```bash
node old_samples/phase-13/1319/server/realNetworkServer.mjs
```
...
```text
http://127.0.0.1:8080/old_samples/index.html
```
...
```text
http://127.0.0.1:8080/old_samples/phase-13/1319/index.html
```
...
```bash
docker compose -f old_samples/phase-13/1319/server/docker-compose.yml up --build
```

Stop:

```bash
docker compose -f old_samples/phase-13/1319/server/docker-compose.yml down
```
