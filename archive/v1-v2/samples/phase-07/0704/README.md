...
# sample 0704 - Mobile Support Tweaks

Sample-local contract for `old_samples/phase-07/0704`.

## Implementation Location

- Entrypoint: `old_samples/phase-07/0704/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-07/0704` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-07/0704/assets/images`.
...
```text
old_samples/phase-07/0704/index.html
old_samples/phase-07/0704
0704
```
