...
# sample 0512 - Performance Metrics

Sample-local contract for `old_samples/phase-05/0512`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0512/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0512` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0512/assets/images`.
...
```text
old_samples/phase-05/0512/index.html
old_samples/phase-05/0512
0512
```
