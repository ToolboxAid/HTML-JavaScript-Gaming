...
# sample 0503 - Damage + Invulnerability Frames

Sample-local contract for `old_samples/phase-05/0503`.

## Implementation Location

- Entrypoint: `old_samples/phase-05/0503/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-05/0503` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-05` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-05/0503/assets/images`.
...
```text
old_samples/phase-05/0503/index.html
old_samples/phase-05/0503
0503
```
