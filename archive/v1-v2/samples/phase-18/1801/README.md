...
Sample-local contract for `old_samples/phase-18/1801`.

## Implementation Location

- Entrypoint: `old_samples/phase-18/1801/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-18/1801` exists and contains `index.html`.
- Preview Generator V2 discovers samples by enumerating directories under `old_samples/phase-18` and keeping only four-digit child folders that contain `index.html`.
...
- Preview and image assets belong under `old_samples/phase-18/1801/assets/images`.
...
```text
old_samples/phase-18/1801/index.html
old_samples/phase-18/1801
1801
```
