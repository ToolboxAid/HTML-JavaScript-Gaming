...
Sample-local contract for `old_samples/phase-03/0320`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0320/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0320` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0320/assets/images`.
...
```text
old_samples/phase-03/0320/index.html
old_samples/phase-03/0320
0320
```
