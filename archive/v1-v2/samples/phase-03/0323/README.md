...
# sample 0323 - Invulnerability Frames

Sample-local contract for `old_samples/phase-03/0323`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0323/index.html`
...
- `index.html`
- `InvulnerabilityFramesScene.js`
- `main.js`

## Discovery Contract

- This sample is valid because the physical folder `old_samples/phase-03/0323` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0323/assets/images`.
...
```text
old_samples/phase-03/0323/index.html
old_samples/phase-03/0323
0323
```
...
# Sample 071 - Invulnerability Frames

Move with WASD or Arrow Keys.
Press Space while overlapping the dummy.
The dummy only takes one hit per invulnerability window.
Press R to reset.
