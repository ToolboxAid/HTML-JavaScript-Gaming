...
# sample 0314 - Pickups Collectibles

Sample-local contract for `old_samples/phase-03/0314`.

## Implementation Location

- Entrypoint: `old_samples/phase-03/0314/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-03/0314` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-03/0314/assets/images`.
...
```text
old_samples/phase-03/0314/index.html
old_samples/phase-03/0314
0314
```
...
# Sample 062 - Pickups / Collectibles

Demonstrates items collected by overlap.
Collected items disappear and increase score.
