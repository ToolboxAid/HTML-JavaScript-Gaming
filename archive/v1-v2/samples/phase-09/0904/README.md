...
# sample 0904 - Raster Mask Collision

Sample-local contract for `old_samples/phase-09/0904`.

## Implementation Location

- Entrypoint: `old_samples/phase-09/0904/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-09/0904` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-09/0904/assets/images`.
...
```text
old_samples/phase-09/0904/index.html
old_samples/phase-09/0904
0904
```
