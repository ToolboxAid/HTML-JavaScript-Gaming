...
Sample-local contract for `old_samples/phase-04/0411`.

## Implementation Location

- Entrypoint: `old_samples/phase-04/0411/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-04/0411` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-04/0411/assets/images`.
...
```text
old_samples/phase-04/0411/index.html
old_samples/phase-04/0411
0411
```
...
## Notes
Press `J`, `J`, then `K`.
The engine tracks recent input history and completes the named chain.
