...
Sample-local contract for `old_samples/phase-01/0121`.

## Implementation Location

- Entrypoint: `old_samples/phase-01/0121/index.html`
...
- This sample is valid because the physical folder `old_samples/phase-01/0121` exists and contains `index.html`.
...
- Preview and image assets belong under `old_samples/phase-01/0121/assets/images`.
...
```text
old_samples/phase-01/0121/index.html
old_samples/phase-01/0121
0121
```
...
## What it shows
- screen-fixed HUD
- screen-fixed debug panel
- world rendering below UI
- ECS-based world entities
- clearer sample feedback

## Controls
- Arrow keys: move player

## Behavior
The player moves through the world while the HUD and debug panels remain fixed on the screen.
